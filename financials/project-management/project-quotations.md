...
Võimalus projekti pakkumiste ja tellimuste müügivõimalusi jälgida, läbi vaadata ning juhtida on projektihalduse oluline osa. Erinevaid vahendeid Microsoft Dynamics 365 toimingute puhul võid need ülesanded. Müügivõimaluste analüüsimisel on abiks näiteks õiged viiteandmete definitsioonid (pakkumiste tüübid, pakkumise päritolu, pakkumise prognoos ja pakkumise tõenäosus). Nende tööriistade abil saate analüüsida, miks projektipakkumine võitis või kaotas ja määrata pakkumise võimalikku väärtust. 

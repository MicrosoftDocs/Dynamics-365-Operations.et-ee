...
| **Väli**                             | **Kirjeldus**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Päevaraha minimaalne tundide arv**           | Saate sisestada töötundide minimaalse arvu, mille töötaja peab päevas töötama, et saada päevaraha reisimisega seotud kulude jaoks.                                                                                      |

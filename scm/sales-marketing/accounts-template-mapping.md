...
- Atribuut **CustomerGroupId** tuleb värskendada rakenduses Finance and Operations kehtivale väärtusele. Saate määrata vaikeväärtuse või määrata väärtuse väärtuskaardi abil. Malli vaikeväärtus on **10**.
- Väli **Aadress, riik, piirkonnakood** on rakenduses Finance and Operations nõutav. Sünkroonimistõrgete vältimiseks saate määrata vaikeväärtuse. Sel juhul kasutatakse seda vaikeväärtust, kui väli on rakenduses Sales tühjaks jäetud.

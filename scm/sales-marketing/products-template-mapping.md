...
-   Veenduge, et mõõtühiku **toetatud kümnendkohad** vastaksid teie nõuetele vastenduses **CDS -\> Sihtkoht**. Kui vajate iga UOM-i puhul erinevaid väärtusi, saate seda teha atribuudiga **ValueMap** ühikust, näiteks, [Igaüks : 0] ja [Nael : 2].

    -   Malli vaikeväärtus on 0.

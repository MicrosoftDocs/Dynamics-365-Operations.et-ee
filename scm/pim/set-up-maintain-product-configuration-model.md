---
title: Toote konfiguratsioon mudelit
...
# <a name="set-up-a-product-configuration-model"></a>Toote konfiguratsioon mudelit

See artikkel kirjeldab toote konfiguratsioonimudeli seadistamise ja loomise samme.

| Ülesanne                                                        | Kirjeldus                                                                                                                                                                                                                                                                                                                                                                                        |
|-------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tooteetaloni loomine.                                    | Tooteetaloni saate luua loendist **Tooteetalon**. Vabastage toote kapten kõikide asjaomaste äriühingute suhtes. Tootemudeli konfiguratsiooni või mõne alamkomponendi versioonina kasutatava toote kasutusluba **piiranguteta põhineva konfiguratsiooni** peab olema märgitud, kui konfiguratsiooni tehnoloogia ja konfiguratsioonidimensioon valitakse ainult kasutatava toote dimensioonigruppi. |

...
[![võimsusriba](./media/orderview.png)](./media/orderview.png)

## <a name="resource-view"></a>Ressursivaade
[![ülevaade](./media/resview.png)](./media/resview.png)
...
Tegevuste võrgus, nt samasse tootmistellimusse kuuluvate tööde puhul, saab kasutada funktsiooni **Eelmiste tööde plaanimine** võrgus valitud tööle eelnevate tööde plaanimiseks. Järgmises näites on esile tõstetud tegevus valitud töö.
...
Võite kasutada funktsiooni **Järgmiste tööde plaanimine** valitud tööle tegevuste võrgus eelnevate tööde plaanimiseks. Järgmises näites on esile tõstetud tegevus valitud töö.
...
Võite kasutada funktsiooni **Plaani töö ümber** valitud tööle tegevuste võrgus järgnevate ja eelnevate tööde plaanimiseks. Järgmises näites on esile tõstetud tegevus valitud töö.
...
| **Leht**                                                                                     | **Kirjeldus**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Tootmistellimuste loend ja üksikasjad**                                                         | Lehel **Tootmistellimuste loend ja üksikasjad** saate avada Gantti diagrammi vähemalt ühest valitud tellimusest. Kui avate diagrammi menüüelemendist **Gantti diagramm**, siis laaditakse kõik valitud tootmistellimustega seotud tööd, kuid ka teiste tootmistellimuste tööd, mis on plaanitud samadele ressurssidele. Diagrammi avamine menüüelemendist **Gantti diagramm – kiirvaade** laadib ainult valitud tootmistellimustega seotud tööd. Selles vaates pole võimalik töid plaanida. |
| **Ressurss**                                                                                 | Lehel **Ressurss** saate avada Gantti diagrammi menüüelemendist **Gantti diagramm**. Kui see on valitud, laaditakse diagrammile kõik ressursile valitud ajavahemikul plaanitud tööd.                                                                                                                                                                                                                                                                                                   |
| **Ressursigrupp**                                                                           | Lehel **Ressursigrupp** saate avada Gantti diagrammi menüüelemendist **Gantti** diagramm. Kui see on valitud, kuvatakse kõik ressursigrupis olevale ressursile plaanitud tööd valitud ajavahemikul.                                                                                                                                                                                                                                                                                    |
| **Gantti diagrammid**                                                                             | Lehel **Gantti diagrammid** saate konfigureerida Gantti diagramme ressursside ja ressursigruppide kaupa. Näiteks kui soovite juhtida tootmistegevusi kindlate ressursikogumite või ressursigruppide puhul, siis võite neid **Gantti diagrammide** lehel eraldi konfigureerida. Seejärel saate avada Gantti diagrammi igast konfiguratsioonist.                                                                                                                                                    |
| **Tunnieelarved** (projekt)                                                                 | Ressursside töögraafikusse saab panna projektitegevused tüübiga **Tunnieelarve**. Lehel **Tunnieelarve** menüüs **Plaanimine** võite avada tellimuse Gantti diagrammi, et vaadata tunnieelarve tüüpi projektitegevusi töögraafikus.                                                                                                                                                                                                                                                             |
| **Tehtav töö** (Loend tööruumis **Tootmisosakonna haldus**)                      | Jaotises **Tehtavad tööd tööruumis Tootmisosakonna haldus** on näha töid tootmis- ja partiitellimustest, mis on tööruumi valitud ressurssidel pooleli. Menüüelemendist **Gantti diagramm** saate avada Gantti diagrammi, kus kõik loendist valitud tööd laaditakse diagrammile.                                                                                                                                                                                |

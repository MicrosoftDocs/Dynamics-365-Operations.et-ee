...
<li>Kui põhimõte on seatud <strong>valitud/aktiivne või valitud</strong>, klõpsates saate valida Koosluse versioon või protsessi versioon <strong>komplekti</strong>&gt;<strong>Koosluse versioonid</strong> või <strong>liinil</strong>&gt;<strong>protsessiversioonide</strong>.</li>
</ul></td>
</tr>
<tr class="even">
...
Kui kasutate koosluse koostajat ühest või mitmest fiktiivse koosluse tasemest koosnevate koosluste ülevaatuseks või redigeerimiseks, siis tavaliselt hõlmab enimmüüdud kaubaga seostatud protsess kogu koosluse hierarhiat. Ülevaate lihtsustamiseks saate lukustada ülataseme liinil Kuva klõpsates **View**&gt;**Lukusta protsess**. Liini avamiseks klõpsake **View**&gt;**Ava liinil**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>Koosluste ja koosluse ridade lisamine ning redigeerimine
Kasutamine on ** koosluseridade ** või **komplekti** funktsioone muuta koosluseridade või Koosluse. Kui valite puus sõlme, määrab sõlme tüüp saadaolevad funktsioonid.

| Funktsioon                            | Kirjeldus                                                                                               | Sõlme tüüp ja tingimused                                                                                                                                                                                                                                                                       |
|-------------------------------------|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Koosluseridade &gt;redigeerimine                 | Avage dialoogikast, kus saab redigeerida koosluse rea atribuute.                                             | See funktsioon on saadaval, kui valitud on koosluse rea sõlm.                                                                                                                                                                                                                                   |
| Koosluseridade &gt;kustutada               | Kustutage koosluse rida valitud kooslusest.                                                                  | See funktsioon on saadaval, kui valitud on koosluse rea sõlm ja kooslus ei ole redigeerimiseks lukustatud.                                                                                                                                                                                             |
| Koosluseridade &gt;lisa rida enne      | Avage dialoogikast, kus saate valida enne valitud koosluse rida kaasatava tootevariandi.         | See funktsioon on saadaval, kui valitud on koosluse rea sõlm.                                                                                                                                                                                                                                   |
| Koosluseridade &gt;komplekti komponendi lisamine | Avage dialoogikast, kus saate valida tootevariandi, mida kaasata valitud koosluse lõppu.       | See funktsioon on saadaval, kui valitud sõlmel on valitud kooslus. Kui see funktsioon ei ole saadaval, võib valitud kauba variandil puududa koosluse versioon. Sel juhul klõpsake **komplekti**&gt;**Loo versioon** valitud sõlme puudu versiooni loomiseks. |
| Koosluseridade &gt;lisa rida pärast       | Avage dialoogikast, kus saate valida pärast valitud koosluse rida kaasatava tootevariandi.          | See funktsioon on saadaval, kui valitud on koosluse rea sõlm.                                                                                                                                                                                                                                   |
| Komplekti &gt;Loo versioon             | Looge valitud sõlme tootevariandile uus koosluse versioon või kooslus.                             | See funktsioon on saadaval, kui valitud koosluse rea sõlm on seotud kaubaga, mille tootmise tüüp on **Kooslus** või **Valem**.                                                                                                                                                  |
| Komplekti &gt;arvutamine                | Avage dialoogikast, kus saate käitada valitud tootevariandi oma- või müügihinna arvutamise. | See funktsioon on saadaval, kui valitud sõlm on seotud koosluse versiooniga.                                                                                                                                                                                                         |
| Komplekti &gt;kontrollida                      | Kinnitage valitud kooslus ja kontrollige seda.                                                                      | See funktsioon on saadaval, kui valitud sõlm on seotud koosluse versiooniga.                                                                                                                                                                                                         |

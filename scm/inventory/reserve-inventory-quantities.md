...
Varusid saab uue tellimuserea loomisel automaatselt reserveerida või igal üksikul tellimusel käsitsi reserveerida. Samuti on võimalik reserveerida varude tootmisprotsessi eri etappides. Ainult ladustatavaid tooteid saab reserveerida. Teenuseid ei saa reserveerida, sest nende puhul ei ole olemas vabu kaubavarusid. Reserveerida saab nii füüsiliselt vabu kaubavarusid kui ka tellitud, kuid veel kätte saamata kaubavarusid. Kui reserveeritakse vabadest kaubavarudest suurem kogus, kuvatakse hoiatus, et nii suurt kogust ei saa reserveerida. Sel juhul valige, kas reserveerite koguse sellest hoolimata või muudate tellitud kogust. Kogust saab reserveerida või muuta. Kui kaupu reserveeritakse rohkem, kui neid on saadaval, kaetakse tekkiv puudujääk järgmisel korral, kui kaubad on tarnimiseks saadaval.
...
| Kauba müügireserveering  | Määrab, kas kauba reserveerimine on manuaalne või automaatne. Kui reserveerimine on automaatne, reserveeritakse varud tellimusridade loomisel. On võimalik teha reserveeringuid koosluste kaubakoodi tasemel (suvand **Automaatne**) või koosluse individuaalsete elementide tasemel (suvand **Koosnevus**). Vaikimisi **kauba müügi reserveerimise** võib olla pärilik **Müügireskontro parameetrid.** Sellel lehel on broneeringu välja seatud on **müük vaikimisi väärtused****lõik** kohta on **üldise** vahekaart. |

...
### <a name="set-up-the-permission-to-move-reserved-inventory-for-individual-workers"></a>Reserveeritud varude teisaldamise õiguse seadistamine eraldi töötajatele

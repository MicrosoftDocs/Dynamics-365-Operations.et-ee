...
description: "Selles artiklis selgitatakse, kuidas seadistada ja kasutada kahte liiki jaemüügi punkti Müügikoht (POS) vahetuses - jagatud ja omaette. Ühiseid vahetusi saab kasutada mitu kasutajat mitmes kohas, samas kui eraldi vahetusi saab kasutada korraga ainult üks töötaja."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Selles artiklis selgitatakse, kuidas seadistada ja kasutada kahte liiki jaemüügi punkti Müügikoht (POS) vahetuses - jagatud ja omaette. Ühiseid vahetusi saab kasutada mitu kasutajat mitmes kohas, samas kui eraldi vahetusi saab kasutada korraga ainult üks töötaja.
...
## <a name="standalone-shifts"></a>Standalone vahetuses
...
1.  Klõpsake **hulgi- ja kaubanduse**&gt;**kanali seaded**&gt;**POS seadistus**&gt;**POS profiilid**&gt;**riistvara profiilid**.
...
4.  Click **Save**.
5.  Klõpsake **hulgi- ja kaubanduse**&gt;**kanali seaded**&gt;**POS seadistus**&gt;**registreerib**.
...
8.  Click **Save**.
9.  Klõpsake **hulgi- ja kaubanduse**&gt;**jaemüügi see**&gt;**jaotus ajakava**.

...
description: See artikkel kirjeldab funktsioone, mis on uued või muutunud Dynamics 365 Supply Chain Management 10.0.19-s.
author: kamaybac
ms.date: 04/23/2021
ms.topic: article
...
See artikkel loetleb funktsioonid, mis on Microsofti versioonis Dynamics 365 Supply Chain Management 10.0.19 uued või muutunud. Selle versiooni number on 10.0.837 ja see on saadaval järgmiselt:
...
Microsoft Dynamics 365 Supply Chain Management 10.0.19 sisaldab platvormivärskendusi. Lisateavet vt platvormi värskendustest [versioonile 10.0.19 finantside ja toimingute rakendustest (juuni 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-19.md).

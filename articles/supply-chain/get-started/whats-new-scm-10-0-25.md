...
|---|---|---|---|
| Varud&nbsp;ja&nbsp;logistika | Ohtlike materjalide täiustused | Need täiustused kogunevad olemasolevatele ohtliku materjali funktsioonidele, et aidata ettevõtetel püsida vastavalt kohalikele seadustele, kui transporditakse ohtlikke materjale erinevatesse geograafilistesse graafikutesse. <!-- KFM: Update to 2022w1 link when published -->| Funktsioonihaldus:<br>*Ohtlike materjalide täiustused* |
| Varud&nbsp;ja&nbsp;logistika | Pakkimistöö pakkimisjaamade jaoks | See funktsioon parandab oluliselt pakkimis- ja lähetustoimingute paindlikkust ja paindlikkust. Pakkimisprotsessi käigus saavad laotöötajad nüüd pakkida ja lähetada sama saadetise ja koormaga seotud üksikuid pakiid. Tellimuseridu, mis on ühe ja sama saadetise osad, ei pea tingimata koos välja minema, kui mõned kaubad on kohe lähetamiseks valmis. Ühe tellimuse saab pakkida ja saata mitmesse pakisse erinevatel lähetusaegadel, vähendades seega ooteaegsid ja lisades ajatagastust.<!-- KFM: Update to 2022w1 link when published --> | Funktsioonihaldus:<br>*Pakkimistöö pakkimisjaamade jaoks* |

---
title: Mis on uut või mida on muudetud rakenduses Dynamics 365 Supply Chain Management 10.0.25 (aprill, 2022)?
description: See artikkel kirjeldab funktsioone, mis on uued või muudetud rakenduses Microsoft Dynamics 365 Supply Chain Management 10.0.25.
author: kamaybac
ms.date: 03/14/2022
ms.topic: article
...
See artikkel loetleb funktsioonid, mis on Microsofti versioonis Dynamics 365 Supply Chain Management 10.0.25 uued või muutunud. Selle versiooni number on 10.0.1149 ja see on saadaval järgmiselt:
...
| Tehnilise muudatuse haldamine | [Tehnilise muudatuse haldamine](../engineering-change-management/product-engineering-overview.md) | Vaikimisi sees |

...
description: See artikkel kirjeldab funktsioone, mis on uued või muutunud Dynamics 365 Supply Chain Management 10.0.18-s.
author: kamaybac
ms.date: 03/01/2021
ms.topic: article
ms.prod: ''
...
See artikkel loetleb funktsioonid, mis on Microsoft Dynamics 365 Supply Chain Management 10.0.18 uued või muutunud. Selle versiooni number on 10.0.793 ja see on saadaval järgmiselt:

- **Väljalaske eelversioon:** märts 2021
- **Väljalaske üldine kättesaadavus (automaatne värskendamine):** aprill 2021
- **Väljalaske üldine kättesaadavus (automaatne värskendamine):** mai 2021
...
- [Varude nähtavuse lisandmoodul](../inventory/inventory-visibility.md)
- [Väljalaadimiskulu moodul](../landed-cost/landed-cost-overview.md)
- [Materjalikäitlusseadmete liides (MHAX)](../warehousing/mhax.md)
- [Planeerimise optimeerimise sobivuse analüüs](../master-planning/planning-optimization/planning-optimization-fit-analysis.md)
...
Microsoft Dynamics 365 Supply Chain Management 10.0.18 sisaldab platvormivärskendusi. Lisateavet vt platvormi värskendustest [versioonile 10.0.18 finantside ja toimingute rakendustest (mai 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18.md).

### <a name="bug-fixes"></a>Veaparandused

Lisateabe saamiseks veaparanduste kohta, mis sisalduvad 10.0.18 uuendustes, logige sisse teenusesse Lifecycle Services (LCS) ja vaadake [KB artiklit](https://fix.lcs.dynamics.com/Issue/Details?bugId=561679&dbType=3&qc=13bb1641c1be430ead8b21ae3d4e0f800d5b81c39b3a56e890db1de7ede59e46).

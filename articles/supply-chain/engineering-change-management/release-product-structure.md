...
description: See artikkel selgitab, kuidas vabastada lõpetatud tootestruktuurid lisaks toodete vabastamisele koos nende tehnikaversioonidega. Sel viisil saate tagada, et tehnilise poolega seotud tooteandmeid saab hõlpsasti kasutada erinevates juriidilistes isikutes.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''

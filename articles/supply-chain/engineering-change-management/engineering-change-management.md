...
Valige uuele tehnika muutmise tellimusele kindlasti õige ettevõte. Kui muudatuse tellimuse tulemuseks on tehnikatoote enda muutmine (uus versioon, uus toode või uus variant), tuleb muudatuse järjekord määrata tehnikaettevõttele. Kui on vaja ainult kohalikku muudatust (**·** *Mõju on seatud väärtusele Pole*), saab muutuse järjekorra määrata kohalikule ettevõttele ja muutused rakenduvad praegusele tootele.
...
## <a name="use-electronic-signatures-to-approve-and-active-boms-and-routes"></a>Elektronallkirjade kasutamine aktiivsete koosluste ja protsesside kinnitamiseks

Elektronallkirjade kasutamiseks koosluste kinnitamiseks ja/või aktiveerimiseks ja/või protsessi muudatuste aktiveerimiseks minge **\>\> organisatsiooni halduse seadistuse elektronallkirja \> elektronallkirja nõuetele.** Seejärel veenduge, et igaühel järgmistest üksustest on nõutud **Allkiri väärtuseks** Jah *·*:

- Tehnilise muutmistellimuse toote koosluse aktiveerimine
- Tehnilise muutmistellimuse toote protsessi aktiveerimine
- Tehnilise muutmistellimuse toote koosluse kinnitamine
- Tehnilise muutmistellimuse toote protsessi kinnitamine
- Tehnilise versiooni koosluse ja koosluse versioonide kinnitamine
- Tehnikaversiooni ja protsessiversiooni kinnitamine

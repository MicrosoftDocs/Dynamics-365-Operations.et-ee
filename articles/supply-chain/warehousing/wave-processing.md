...
ms.locfileid: "5813647"
---
# <a name="wave-creation-and-processing"></a>Voo loomine ja töötlemine

[!include [banner](../includes/banner.md)]

See teema kirjeldab, kuidas luua, töödelda ja väljastada voogu koorma, saadetise, tootmistellimuse või kanban-tellimuse komplekteerimistöö loomiseks. Võite luua järgmiste tellimustüüpide voogusid.

...
description: See artikkel kirjeldab, kuidas kanbani väljastamist kasutatakse tootmistegevuste materjali täiendamiseks.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863704"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Täiendamine tagastamiskanbanitega

[!include [banner](../includes/banner.md)]

See artikkel kirjeldab, kuidas kanbani väljastamist kasutatakse tootmistegevuste materjali täiendamiseks.

...
description: See artikkel kirjeldab, kuidas seadistada ja hallata kasutajakontosid, mis võimaldavad töötajatel lao rakendusse sisse logida ja neid kasutada.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''

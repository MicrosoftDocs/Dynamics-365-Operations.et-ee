...
description: See artikkel annab teavet väljamineva sortimise kohta. See funktsioon hõlbustab väikeste konteinerite käsitsemist ja aitab lao töötajatel veokis kaubaaluste mahutavust tõhusamalt planeerida ja korraldada.
author: Mirzaab
ms.date: 07/15/2020
ms.topic: article
ms.prod: ''

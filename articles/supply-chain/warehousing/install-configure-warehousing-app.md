...
Selles teemas kirjeldatakse rakenduse Microsoft Dynamics 365 for Finance and Operations mooduli Ladustamine installimist ja konfigureerimist.
...
> [!NOTE]
> Zebra App Gallery on kasutuselt kõrvaldatud, mis tähendab, et rakendust Finance and Operations – Ladustamine ei saa sealt enam alla laadida.
...
Selleks et rakendus saaks konkreetse Finance and Operationsi serveriga suhelda, tuleb registreerida veebiteenuse rakendus Azure Active Directorys Finance and Operationsi rentnikule. Turvalisusega seotud põhjustel on soovitatav luua veebiteenuse rakendus igale kasutatavale seadmele. Veebiteenuse rakenduse loomiseks Azure Active Directorys (Azure AD) tehke järgmist.
...
Selleks et võimaldada Finance and Operationsil teie Azure AD rakendust kasutada, peate tegema järgmised konfigureerimistoimingud.
...
2.  Seostage oma Azure Active Directory rakendus laorakenduse kasutajaga.
    1.  Avage Finance and Operationsis **Süsteemihaldus** &gt; **Seadistus** &gt; **Azure Active Directory rakendused**.
    2.  Looge uus rida.
...
Teavet rakenduse Dynamics 365 for Finance and Operations – Ladustamine seadistamise kohta skannima mobiilse seadme kaamera abil vöötkoode, vt teemast [Vöötkoodide skannimine kaameraga rakenduses Dynamics 365 for Finance and Operations – Ladustamine](scan-bar-codes-using-a-camera.md)

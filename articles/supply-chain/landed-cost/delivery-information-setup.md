...
description: See artikkel kirjeldab, kuidas seadistada väljaminev kulumooduli tarneteavet.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895608"
---
# <a name="delivery-information-setup"></a>Tarneteabe häälestus

[!include [banner](../../includes/banner.md)]

See artikkel kirjeldab, kuidas seadistada väljaminev **kulumooduli tarneteavet**.

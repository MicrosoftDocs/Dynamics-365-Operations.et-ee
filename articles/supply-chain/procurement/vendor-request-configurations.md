...
-   <span data-ttu-id="f7535-114">Peidetud (pole nähtav)</span><span class="sxs-lookup"><span data-stu-id="f7535-114">Hidden (Not visible)</span></span>
-   <span data-ttu-id="f7535-115">Kuvatud (nähtav, kuid pole kohustuslik)</span><span class="sxs-lookup"><span data-stu-id="f7535-115">Displayed (Visible but not mandatory)</span></span>
-   <span data-ttu-id="f7535-116">Nõutav (nähtav ja kohustuslik)</span><span class="sxs-lookup"><span data-stu-id="f7535-116">Required (Visible and mandatory)</span></span>

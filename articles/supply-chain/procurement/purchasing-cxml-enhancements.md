...
- Hankija seadistamiseks nii, et see kasutaks kõigi uute ostutaotlusest loodavate ostutellimuste puhul automaatselt cXML-i, avage **Hanked \> Hankijad \> Kõik hankijad** ning valige või looge hankija, et avada selle üksikasjade leht. Seejärel seadke kiirkaardil **Ostutellimuse vaikesätted** suvandi **Saada ostutellimus cXML-i kaudu** väärtuseks _Jah_. Kui cXML-i **tuleks** kasutada ka automaatselt uute ostutellimuste puhul, mis ei ole taotlusest loodud, **peate määrama ka atribuudi ENABLEMANUALPO** tellimuse _kohta_ väärtusele Tõene seotud välisele kataloogile, [nagu](#set-order-properties) on kirjeldatud selles artiklis allpool jaotises Tellimuse atribuutide seada.
...
- **USERAGENT** – sisestage väärtus süsteemi tuvastamiseks, mida te kasutate. Näiteks sisestage Dynamics _365 tarneahela haldus_.
...
Igal ostutellimusel võib olla palju kinnitusi. Iga kinnitus on märgitud suureneva numbriga. Järgmises näites on ostutellimus *00000275* ja kinnitus *00000275-1*. See nummerdamine kajastab rakenduse Supply Chain Management standardset funktsiooni, mille puhul tuvastatakse kinnituse põhjal ostutellimuse muudatused ja seetõttu ka hankijale saadetava cXML-i teate tüüp. Nagu illustratsioonilt näha, hõlmab leht **Ostutellimuse kinnitused** ka välju **Tellimuse saatmise olek** ja **Tellimustaotluse hankija olek**. Lisateavet erinevate olekuväärtuste kohta, mida võite sellel leheküljel näha, [vt selle](#monitor-po-requests) artikli jaotisest Ostutellimuse taotluste s vaikeväärtused.

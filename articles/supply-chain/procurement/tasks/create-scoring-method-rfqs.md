...
1. Valige Hanked > Seadistus > Pakkumiskutse > Hindamismeetod.
...
8. Sisestage väljale Kirjeldus soovitud väärtus.
    * Kirjeldus kuvatakse koos hindamismeetodi nimega, kui hindamismeetod pakkumiskutse puhul valitakse.  
9. Sisestage number väljale Vahemik alates.
    * Vahemiku piirid, mille hankespetsialist saab skoorina sisestada. Kui pakkumiskutsel on mitu hindamiskriteeriumi, liidetakse sisestatud skoorid üksteisele ja summa tehakse kättesaadavaks, et pakkumisi saaks võrrelda.  
10. Sisestage number väljale Vahemik kuni.
11. Klõpsake valikut Uus.
12. Sisestage väärtus väljale Nimi.
13. Sisestage väljale Kirjeldus soovitud väärtus.

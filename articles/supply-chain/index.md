...
- [Lean manufacturing: funktsioon „võimeline lubama“ ja kanban-tööde planeerimine](https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/white-papers/leanmanufkanban365opt/)
- [Koosluse arvutamine kuluarvutustabeli abil](https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/white-papers/365operationsbomcalsheet/)

## <a name="elearning-courses"></a>E-õppe kursused

Veebikursuste ja koolituse kohta vt [Dynamics 365 Microsoft Learnis](https://docs.microsoft.com/learn/dynamics365/).

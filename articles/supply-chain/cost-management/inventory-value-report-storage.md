...
description: See teema kirjeldab, kuidas seadistada, luua ja kasutada laoväärtuse aruandeid. Need aruanded annavad üksikasju teie varude füüsiliste ja finantskoguste ja -summade kohta.
author: banluo-ms
ms.date: 10/19/2021
ms.topic: article
...
## <a name="export-an-inventory-value-report-storage-report"></a>Varude väärtuse aruande eksportimine ladustamisaruandena

...
description: Selles artiklis käsitletakse ohutusvaru täitmist ja kaupadele ohutusvaru koguse seadistamist.
author: t-benebo
ms.date: 8/23/2021
ms.topic: article
...
> [!NOTE]
> Kõigi selle artikli illustratsioonide puhul näitab x-telg varusid, y-telg tähistab päevasid, ribad tähistavad laotaset, nooled tähistavad kandeid, nt müügitellimuse ridu, ostutellimuse ridu või plaanitud tellimusi.

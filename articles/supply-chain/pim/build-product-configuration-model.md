...
Järgmine API voog visandab protsessi.  

[![Voodiagramm.](./media/product_configuration_2.png)](./media/product_configuration_2.png)  

## <a name="configure-products"></a>Toodete konfigureerimine

### <a name="configure-one-or-more-products"></a>Ühe või mitme toote konfigureerimine

Saate tooteid konfigureerida järgmistest kohtadest:
...
Konfiguratsiooni eesmärk on luua tootest selge variant, mis vastab kliendi nõudmistele. Igale uuele konfiguratsioonile luuakse kordumatu ID. See ID võimaldab lao kaudu jälgimist.

### <a name="multiple-sites-and-intercompany-considerations"></a>Mitu saiti ja ettevõtete vahelised tasud

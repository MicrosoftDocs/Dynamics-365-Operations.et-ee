...
description: See artikkel kirjeldab, kuidas hallata toodete, tootedimensiooni väärtuste ja toote atribuutide tõlkeid.
author: t-benebo
ms.date: 08/06/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9015402"
---
# <a name="product-related-translations-faq"></a>Tootega seotud tõlgete KKK

[!include [banner](../includes/banner.md)]

See artikkel kirjeldab, kuidas hallata toodete, tootedimensiooni väärtuste ja toote atribuutide tõlkeid. 
...
1.  Klõpsake tooteteabe **halduse väljastatud** &gt; **·** &gt; **tooteid**.

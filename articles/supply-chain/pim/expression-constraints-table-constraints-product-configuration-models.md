...
description: See artikkel kirjeldab avaldise piirangute ja tabelipiirangute kasutamist. Piirangute abil kontrollitakse atribuutide väärtusi, mida saab valida toodete konfigureerimisel müügitellimuse, müügipakkumise, ostutellimuse või tootmistellimuse jaoks. Saate avaldise piiranguid või tabeli piiranguid kasutada sõltuvalt sellest, kuidas soovite piiranguid luua.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
See artikkel kirjeldab avaldise piirangute ja tabelipiirangute kasutamist. Piirangute abil kontrollitakse atribuutide väärtusi, mida saab valida toodete konfigureerimisel müügitellimuse, müügipakkumise, ostutellimuse või tootmistellimuse jaoks. Saate avaldise piiranguid või tabeli piiranguid kasutada sõltuvalt sellest, kuidas soovite piiranguid luua. 
...
<tr class="odd">
<td>Tähendab</td>
<td>Kui tingimus a on tõene, siis rakendage "int b".</td>
...
[Avaldise piirangu loomine](tasks/add-expression-constraint-product-configuration-model.md)

[Arvutuse lisamine toote konfiguratsioonimudelile](tasks/add-calculation-product-configuration-model.md)

...
## <a name="associate-product-lifecycle-states-to-released-products"></a><span data-ttu-id="024f0-115">Toote elutsükli olekute seostamine väljastatud toodetega</span><span class="sxs-lookup"><span data-stu-id="024f0-115">Associate product lifecycle states to released products</span></span>  

<span data-ttu-id="024f0-116">Toote elutsükli oleku seostamiseks väljastatud toodete või tootevariantidega on mitu võimalust.</span><span class="sxs-lookup"><span data-stu-id="024f0-116">There are multiple ways to associate a product lifecycle state to released products or product variants.</span></span>

-  <span data-ttu-id="024f0-117">Uue väljastatud toote loomisel määratakse sellele automaatselt vaikimisi **Toote elutsükli olek**.</span><span class="sxs-lookup"><span data-stu-id="024f0-117">On creation of a new released product, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="024f0-118">Toote väljastamisel juriidilisele isikule määratakse sellele automaatselt vaikimisi **Toote elutsükli olek**.</span><span class="sxs-lookup"><span data-stu-id="024f0-118">On release of a product to a legal entity, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="024f0-119">Tootevariandi väljastamisel juriidilisele isikule määratakse uuele variandile automaatselt selles juriidilises isikus väljasatud tooteetaloniga seostatud **Toote elutsükli olek**.</span><span class="sxs-lookup"><span data-stu-id="024f0-119">On release of a product variant to a legal entity, the **Product lifecycle state** associated to the released product master in this legal entity is automatically assigned to the new variant.</span></span> 

<span data-ttu-id="024f0-120">Toote elutsükli oleku käsitsi värskendamiseks on järgmised võimalused.</span><span class="sxs-lookup"><span data-stu-id="024f0-120">You can manually update the product lifecycle state by using:</span></span> 

-    <span data-ttu-id="024f0-121">Loendileht **Väljastatud tooted** või **Üksikasjavaade**.</span><span class="sxs-lookup"><span data-stu-id="024f0-121">The **Released products** list page or **Details view**.</span></span> 
-  <span data-ttu-id="024f0-122">Loendileht **Väljastatud tootevariandid** või **Üksikasjavaade**.</span><span class="sxs-lookup"><span data-stu-id="024f0-122">The **Released product variants** list page or **Details view**.</span></span> 
-  <span data-ttu-id="024f0-123">Saate leida aegunud tooted või tootevariandid nõudluse põhjal ja seostada need elutsükli olekuga.</span><span class="sxs-lookup"><span data-stu-id="024f0-123">Find the obsolete products or product variants based on demand and associate a lifecycle state.</span></span>  

<span data-ttu-id="024f0-124">Üksikasjalikku teavet toote elutsükli olekute seostaimseks esitage või lugege kaht järgmist tegevusejuhist.</span><span class="sxs-lookup"><span data-stu-id="024f0-124">For detailed information about how to associate product lifecycle states, play or read the following two task guides.</span></span>

-  <span data-ttu-id="024f0-125">Toote elutsükli oleku seostamiseks väljastatud tooteetaloniga esitage või lugege tegevusejuhist **Toote elutsükli oleku määramine väljastatud tooteetalonile**.</span><span class="sxs-lookup"><span data-stu-id="024f0-125">To associate a product lifecycle state to a released product master, play or read the task guide **Assign a product lifecycle state to a released product master**.</span></span> 

-  <span data-ttu-id="024f0-126">Toote elutsükli oleku seostamiseks väljastatud tootega esitage või lugege tegevusejuhist **Toote elutsükli oleku määramine väljastatud tootele**.</span><span class="sxs-lookup"><span data-stu-id="024f0-126">To associate a product lifecycle state to a release product, play or read the task guide **Assign a product lifecycle state to a released product**.</span></span> 

## <a name="impact-on-master-planning"></a><span data-ttu-id="024f0-127">Mõju koondplaneerimisele</span><span class="sxs-lookup"><span data-stu-id="024f0-127">Impact on master planning</span></span> 

<span data-ttu-id="024f0-128">Toote elutsükli olekul on ainult üks juhtlipp: **On planeerimiseks aktiivne**.</span><span class="sxs-lookup"><span data-stu-id="024f0-128">The product lifecycle state has only one control flag: **Is active for planning**.</span></span> <span data-ttu-id="024f0-129">Vaikimisi on selle sätteks kõigi loodud toote elutsükli olekut puhul **Jah**, kuid selle saab muuta sättele **Ei**.</span><span class="sxs-lookup"><span data-stu-id="024f0-129">By default, this is set to **Yes** for all created product lifecycle states, but it can be changed to **No**.</span></span> <span data-ttu-id="024f0-130">Kui valitud on säte **Ei**, on seostatud väljastatud tooted või väljastatud tootevariandid:</span><span class="sxs-lookup"><span data-stu-id="024f0-130">When set to **No**, the associated released products or released product variants are:</span></span> 

-  <span data-ttu-id="024f0-131">välistatud koondplaneerimisest;</span><span class="sxs-lookup"><span data-stu-id="024f0-131">Excluded from master planning.</span></span> 
-  <span data-ttu-id="024f0-132">välistatud koosluse taseme arvutusest.</span><span class="sxs-lookup"><span data-stu-id="024f0-132">Excluded from BOM-level calculation.</span></span> 

<span data-ttu-id="024f0-133">Täpsema teabe saamiseks selle kohta, kuidas kasutada toote elutsükli olekut toodete välistamiseks koondplaneerimisest ja koosluse taseme arvutustest, esitage või lugege tegevusejuhist **Toote elutsükli oleku loomine toote välistamiseks koondplaneerimisest**.</span><span class="sxs-lookup"><span data-stu-id="024f0-133">For detailed information about how to use product lifecycle state to exclude products from master planning and BOM-level calculation, play or read the task guide **Create a product lifecycle state to exclude products from Master planning**.</span></span>
...
-  <span data-ttu-id="024f0-153">Toode või tootevariant loodi mõni päev tagasi valiku dialoogiboksis sisestatud päevade arvu alusel.</span><span class="sxs-lookup"><span data-stu-id="024f0-153">The product or product variant was created some days ago based on the number of days that you enter in the selection dialog box.</span></span> 
-  <span data-ttu-id="024f0-154">Toote või tootevariandi puhul ei ole avatud tootetellimusi (= olek < lõpetatud).</span><span class="sxs-lookup"><span data-stu-id="024f0-154">There are no open production orders (= status < ended) for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-155">Toote või tootevariandi pole avatud varude kandeid (= väljastamise olek valikult ReservPhysical valikule QuotationIssue või vastuvõtmise olek valikult Registreeritud valikule QuotationReceipt).</span><span class="sxs-lookup"><span data-stu-id="024f0-155">There are no open inventory transactions (= status issue ReservPhysical to QuotationIssue or status receipt Registrered to QuotationReceipt) for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-156">Toote või tootevariandi puhul pole viimaste päevade jooksul ühtki varude kandeid.</span><span class="sxs-lookup"><span data-stu-id="024f0-156">There are no inventory transactions within the last number of days for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-157">Toote või tootevariandi puhul puudub tulevane nõudlus või tarneprognoos.</span><span class="sxs-lookup"><span data-stu-id="024f0-157">There is no future demand or supply forecast for the product or product variant.</span></span>  
-  <span data-ttu-id="024f0-158">Toote või tootevariandi puhul pole kauba laovarudele minimaalset varude taset määratud.</span><span class="sxs-lookup"><span data-stu-id="024f0-158">No minimum stock level has been set in item coverage for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-159">Toote või tootevariandi puhul pole aktiivset fikseeritud koguse kanban-reeglit.</span><span class="sxs-lookup"><span data-stu-id="024f0-159">No active fixed quantity kanban rule for the product or product variant.</span></span>  
-  <span data-ttu-id="024f0-160">Toote või tootevariandi puhul pole teenuse tellimuserida.</span><span class="sxs-lookup"><span data-stu-id="024f0-160">No service order line for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-161">Toote või tootetellimuse puhul pole aktiivseid ega tulevasi müüke või ostutellimuse ridu.</span><span class="sxs-lookup"><span data-stu-id="024f0-161">No active or future sales or purchase agreement lines for the product or product variant.</span></span> 
-  <span data-ttu-id="024f0-162">Toote või tootevarianti ei kasutata koosluses, mis on seostatud planeerimiseks aktiivse toote või tootevariandi puhul mitteaegunud kinnitatud koosluse versiooniga.</span><span class="sxs-lookup"><span data-stu-id="024f0-162">The product or product variant is not used in a BOM that is associated with a non-expired approved BOM version for a product or variant that is active for planning.</span></span>

## <a name="related-topics"></a><span data-ttu-id="024f0-163">Seotud dokumendid</span><span class="sxs-lookup"><span data-stu-id="024f0-163">Related topics</span></span>

-  [<span data-ttu-id="024f0-164">Uue toote elutsükli oleku loomine (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-164">Create a new product lifecycle state (Task guide)</span></span>](tasks/new-product-lifecycle-state.md)
-  [<span data-ttu-id="024f0-165">Toote elutsükli oleku vaikeväärtuse loomine (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-165">Create a default product lifecycle state (Task guide)</span></span>](tasks/default-product-lifecycle-state.md)
-  [<span data-ttu-id="024f0-166">Toote elutsükli oleku määramine väljastatud tooteetalonile (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-166">Assign a product lifecycle state to a released product master (Task guide)</span></span>](tasks/product-lifecycle-state-released-product-master.md)
-  [<span data-ttu-id="024f0-167">Toote elutsükli oleku määramine väljastatud tootele (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-167">Assign a product lifecycle state to a released product (Task guide)</span></span>](tasks/product-lifecycle-state-released-product.md)
-  [<span data-ttu-id="024f0-168">Aegunud tootevariantide leidmine ja neile toote elutsükli oleku määramine (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-168">Find obsolete product variants and assign a product lifecycle state (Task guide)</span></span>](tasks/obsolete-product-variants.md)
-  [<span data-ttu-id="024f0-169">Toote elutsükli oleku loomine toodete välistamiseks koondplaneerimisest (tegevuse juhis)</span><span class="sxs-lookup"><span data-stu-id="024f0-169">Create a product lifecycle state to exclude products from Master planning (Task guide)</span></span>](tasks/exclude-products-master-planning.md)

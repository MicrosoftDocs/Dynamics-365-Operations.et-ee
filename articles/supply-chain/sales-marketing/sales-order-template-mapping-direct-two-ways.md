...
description: Artikkel käsitleb malle ja aluseks olevaid ülesandeid, mida kasutatakse müügitellimuste sünkroonimise käivitamiseks otse Dynamics 365 müügi ja rakenduse vahel Dynamics 365 Supply Chain Management.
author: Henrikan
ms.date: 05/09/2019
ms.topic: article
ms.prod: ''
...
Artikkel käsitleb malle ja aluseks olevaid ülesandeid, mida kasutatakse müügitellimuste sünkroonimise käivitamiseks otse Dynamics 365 müügi ja rakenduse vahel Dynamics 365 Supply Chain Management.
...
[![Mallide kaardistamine andmete integreerimisel, Müügitellimustes (rakendusest Supply Chain Management rakendusse Sales) – Otse: OrderHeader.](./media/sales-order-direct-template-mapping-data-integrator-1.png)](./media/sales-order-direct-template-mapping-data-integrator-1.png)
...
[![Mallide kaardistamine andmete integreerimisel, Müügitellimustes (rakendusest Supply Chain Management rakendusse Sales) – Otse: OrderLine.](./media/sales-order-direct-template-mapping-data-integrator-2.png)](./media/sales-order-direct-template-mapping-data-integrator-2.png)
...
[![Mallide kaardistamine andmete integreerimisel, Müügitellimustes (rakendusest Sales rakendusse Supply Chain Management) – Otse: OrderHeader.](./media/sales-order-direct-template-mapping-data-integrator-3.png)](./media/sales-order-direct-template-mapping-data-integrator-3.png)
...
[![Mallide kaardistamine andmete integreerimisel, Müügitellimustes (rakendusest Sales rakendusse Supply Chain Management) – Otse: OrderLine.](./media/sales-order-direct-template-mapping-data-integrator-4.png)](./media/sales-order-direct-template-mapping-data-integrator-4.png)

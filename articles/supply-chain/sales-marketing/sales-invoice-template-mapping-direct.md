...
ms.locfileid: "9103271"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>Müügiarve päiste ja ridade sünkroonimine otse finantsidelt ja toimingutelt müükidesse
...
![Mallide vastendamine SalesInvoiceHeader andmete integreerimisel.](./media/sales-invoice-direct-template-mapping-data-integrator-1.png)

### <a name="salesinvoiceline"></a>SalesInvoiceLine

![Mallide vastendamine SalesInvoiceLine andmete integreerimisel.](./media/sales-invoice-direct-template-mapping-data-integrator-2.png)

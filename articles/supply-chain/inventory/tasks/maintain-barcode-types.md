...
1. Avage **Vöötkoodid**.
1. Valige suvand **Uus**.
1. Sisestage väärtus väljale **Vöötkoodide häälestus**.
1. Sisestage väärtus väljale **Kirjeldus**.
1. Valige suvand väljalt **Vöötkoodi tüüp**.
    * USMF-i kasutamisel saate valida suvandi Kood 39.
1. **Maski ID** väljal saate täpsustada vöötkoodi maski ID. Vöötkoodimaske kasutatakse vöötkoodide loomiseks ja kassas (POS) skannitavate vöötkoodide kiiresti tuvastamiseks. Lisateavet vt [vöötkoodi maskide häälestus](../../../commerce/set-up-bar-code-masks.md).
1. Sisestage number väljale **Suurus**.
1. Sisestage number väljale **Maksimaalne pikkus**.
1. Valige käsk **Salvesta**.
1. Sulgege leht.
1. Minge jaotisse **Varude ja laohalduse parameetrid**.

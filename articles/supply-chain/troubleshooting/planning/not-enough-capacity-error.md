...
On mitu põhjust, miks planeerimismootor võib nurjuda ja väljastada selle tõrketeate. Juhiste kohta, mis aitavad teil leida tõrke juurpõhjuse ja seejärel selle leevendada, vt [Parandage "Ei leitud piisavalt võimsust" tõrkele plaanimismootori planeerimisel](/dynamics365/supply-chain/master-planning/not-enough-capacity-error-resolution.md).

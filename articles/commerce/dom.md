...
## <a name="set-up-dom"></a>DOM-i häälestus
...
9. Reeglite määratlemiseks valige suvandid **Retail ja Commerce \> Hajutatud tellimuste haldamine \> Häälestus \> Reeglite haldamine**. Praegu toetatakse järgmisi DOM-i reegleid.
    ...
    - **Osaliste tellimuste reegel** – see reegel laseb organisatsioonidel määrata, kas tellimust või tellimuse rida saab täitsa osaliselt. Saadaval on järgmised parameetrid.
        ...
        | Kombinatsiooni number | Osaliste tellimuste täitmine | Osaliste ridade täitmine | Tellimuse täitmine ainult ühest asukohast | Kirjeldus |
        |------|------------------------|-----------------------|--------------------------------------|-------------|

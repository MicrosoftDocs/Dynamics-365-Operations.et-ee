...
## <a name="select-the-site-theme"></a>Saidi kujunduse valimine

Saidil rakendatava kujunduse valimiseks järgige neid etappe.

1. Saidi autorluse keskkonnas minge saidile.
1. Avage suvand **Saidi haldus** \> **Laiendatavus**.
1. Jaotises **Kujundus** valige rippmenüüst kujundus.
1. Valitud kujunduse rakendamiseks saidile valige suvand **Salvesta ja avalda**.

> [!NOTE]
> Teie valitud kujundus avaldatakse saidil kohe, kui valite suvandi **Salvesta ja avalda** lehel **Laiendatavus**. Oma saidi kujunduse eelvaateks enne selle rakendamist saate kasutada oma arendus- või liivakasti keskkonda.

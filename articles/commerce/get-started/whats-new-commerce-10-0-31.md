...
| Saadaolevad lisakeeled | Saadaval on neli lisakeelt | Eelistatud keeleloendis on kasutaja jaoks saadaval neli uut keelt: korea, portugali (Klahvi), Ja hiina (traditsiooniline). Selle suvandi valimiseks minge kasutaja suvandite **eelistuskeelele \>  \> ja riigi/regiooni eelistusele**. | Lokaliseeritud eelistused |  

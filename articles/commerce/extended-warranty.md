---
title: Põhjalikumate garantiide loomine ja konfigureerimine
description: See artikkel katab laiendatud garantiid ja kirjeldab, kuidas neid luua ja konfigureerida Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 06/08/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268364"
---
# <a name="create-and-configure-extended-warranties"></a>Põhjalikumate garantiide loomine ja konfigureerimine

[!include [banner](includes/banner.md)]

See artikkel katab laiendatud garantiid ja kirjeldab, kuidas neid luua ja konfigureerida Microsoft Dynamics 365 Commerce.

...
description: Selles artiklis kirjeldatakse Dynamics 365 Commerce'i hajutatud tellimuste haldamise (DOM) funktsiooni kulukonfiguratsiooni.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''

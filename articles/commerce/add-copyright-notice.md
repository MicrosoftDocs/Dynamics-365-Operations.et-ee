...
description: See artikkel kirjeldab, kuidas lisada autoriõigusteatist oma e-äri veebisaidile.
author: psimolin
ms.date: 10/16/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8851185"
---
# <a name="add-a-copyright-notice"></a>Autoriõiguste teatise lisamine

[!include [banner](includes/banner.md)]

See artikkel kirjeldab, kuidas lisada autoriõigusteatist oma e-äri veebisaidile.

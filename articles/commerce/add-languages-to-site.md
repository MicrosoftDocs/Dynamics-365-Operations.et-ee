...
Saate oma veebisaidi lokaliseerida mis tahes keelde, mida Dynamics 365 Commerce toetab. (Toetatud keelte loend on toodud selles teemas hiljem.) Oma veebisaidile keele lisamiseks peate selle kõigepealt lisama oma saidiga seotud veebipoele.

## <a name="add-a-language-to-an-online-store"></a>Veebipoel keele lisamine

Veebipoele keele lisamiseks tehke järgmist.

1. Avage oma saidi Dynamics 365 Retaili keskkond.
1. Avage **Jaemüük \> Kanalid \> Veebipoed**, et avada veebipoodide loend, mis on teie keskkonna jaoks konfigureeritud. Teise võimalusena sisestage otsingusõnaks **veebipoed**.

...
description: Selles artiklis selgitatakse, kuidas kasutada ühiskasutatavaid numbriseeriaid kliendi kopeerimiseks teise juriidilisse isikusse, säilitades sama kliendi ID.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''

...
description: Selles artiklis kirjeldatakse põhivarakannete loomiseks saadaolevaid erinevaid meetodeid.
author: moaamer
ms.date: 08/10/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8883354"
---
# <a name="fixed-asset-transaction-options"></a>Põhivarakande valikud

[!include [banner](../includes/banner.md)]

Selles artiklis kirjeldatakse põhivarakannete loomiseks saadaolevaid erinevaid meetodeid.

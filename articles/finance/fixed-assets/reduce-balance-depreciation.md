...
Saate teha valiku **Kalendriaasta** või **Rahandusaasta** väljalt **Kulumiarvestusaasta** lehel **Kulumireeglid**. Valik määratleb väljal **Perioodi sagedus** saadaolevad suvandid. Vaikesuvandiks on **Kalender**.

### <a name="calendar"></a>Kalender

Suvandiga **Kalender** värskendatakse iga aasta 1. jaanuaril kulumiarvestuse alust, milleks on tavaliselt raamatupidamislik jääkväärtus miinus mahakandmismaksumus. Selles artiklis hilisemas vähenev saldoga kulumi näites on kulumiarvestuse alus arvutusveeru esimese avaldise lugeja. 

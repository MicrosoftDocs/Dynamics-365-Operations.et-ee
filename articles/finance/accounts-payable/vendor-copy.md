...
description: Selles artiklis selgitatakse, kuidas kasutada ühiskasutatavaid numbriseeriaid hankija kopeerimiseks teise juriidilisse isikusse, säilitades sama hankija ID.
author: sunfzam
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''

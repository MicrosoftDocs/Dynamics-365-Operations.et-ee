...
description: See artikkel selgitab, kuidas seadistada hankija arvetega seotud tööruumi ja see näitab teavet, mis on saadaval Microsoft Power BI.
author: abruer
ms.date: 02/14/2022
ms.topic: article
ms.prod: ''
...
See artikkel selgitab, kuidas seadistada hankija arvetega seotud tööruumi ja see näitab teavet, mis on saadaval Microsoft Power BI. Selle tööruumi hankija arve teave filtreeritakse kindlatele kasutajatele ja kuvatakse graafikuna.

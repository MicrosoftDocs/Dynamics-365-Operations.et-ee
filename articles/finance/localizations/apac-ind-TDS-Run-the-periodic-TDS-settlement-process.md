...
description: See artikkel selgitab, kuidas tasakaalustada allikas mahaarvatud perioodilist maksu (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8864238"
---
# <a name="run-the-periodic-tds-settlement-process"></a>Perioodilise TDS-i tasakaalustusprotsessi käitamine

[!include [banner](../includes/banner.md)]

See artikkel selgitab, kuidas tasakaalustada allikas mahaarvatud perioodilist maksu (TDS).

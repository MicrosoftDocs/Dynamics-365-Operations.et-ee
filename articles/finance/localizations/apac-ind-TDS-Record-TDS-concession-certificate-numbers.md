...
description: See artikkel selgitab, kuidas kirjendada mahaarvamisega maks allika (TDS) kontsessiooniserdi numbrites, mis väljastatakse hankijatele.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846609"
---
# <a name="record-tds-concession-certificate-numbers"></a>TDS-i kontsessioonisertifikaadi numbrite kirjendamine

[!include [banner](../includes/banner.md)]

See artikkel selgitab, kuidas kirjendada mahaarvamisega maks allika (TDS) kontsessiooniserdi numbrites, mis väljastatakse hankijatele.

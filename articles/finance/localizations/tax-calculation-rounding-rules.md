...
description: See artikkel annab teavet maksu arvutamise teenuse maksu arvutamise parameetrite ümardamisreeglite kohta.
author: kailiang
ms.date: 07/29/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858297"
---
# <a name="tax-calculation-rounding-rules"></a>Maksuarvutuse ümardamisreeglid

[!include [banner](../includes/banner.md)]

See artikkel annab teavet selle kohta, kuidas ümardamisreeglid maksu arvutamise teenuse maksuarvutuse parameetrites töötavad.
...
Väli **Ümardamistäpsus** toetab väärtust, millel on kuni kuus kümnendkohta. Kui seate näiteks **ümardamise** **täpsuse välja väärtuseks 0.000000**, ümardatakse arvutatud summad kuue Microsoft Dynamics kümnendkohani ja saadetakse seejärel rakendusse 365 Finance. Näiteks kui kasutatakse ümardamismeetodit **Tavaline**, ümardatakse summa **987,1234567** summaks **987,123457**.

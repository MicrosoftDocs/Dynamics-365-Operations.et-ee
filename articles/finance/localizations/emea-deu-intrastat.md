...
description: See artikkel sisaldab teavet Saksamaa Intrastat-deklaratsiooni kohta.
author: AdamTrukawka
ms.date: 09/09/2021
ms.topic: article
...
3. Väliskaubanduse parameetrite häälestamine:
    ...
    1. Rakenduses Dynamics 365 Finance minge maksu **seadistamise** > **väliskaubanduse** > **parameetritele**.

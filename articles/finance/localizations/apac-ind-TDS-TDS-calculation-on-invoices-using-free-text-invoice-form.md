...
description: See artikkel selgitab, kuidas arvutada arvetel allika järgi mahaarvatud maks (TDS), kasutades vabas vormis arvelehte.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
See artikkel selgitab, kuidas arvutada arvetel allika järgi mahaarvatud maks (TDS), kasutades vabas **vormis arvelehte**.

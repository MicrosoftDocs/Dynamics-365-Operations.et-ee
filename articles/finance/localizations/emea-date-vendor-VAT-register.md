...
description: Selles teemas antakse teavet funktsiooni kohta hankija KM-registri kuupäeva lubamiseks
author: anasyash
ms.date: 01/15/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7991728"
---
# <a name="date-of-vendor-vat-register"></a>Hankija KM-registri kuupäev

Microsofti Dynamics 365 Finance versioonis 10.0.24 on hankija arvete jaoks saadaval uus **hankija** KM-registri kuupäev. See väli määrab ostu maksustatavate tarnete kuupäeva.
...
Mõned KM-aruanded, nt KM-i kontrollimise aruanne Tšehhi Vabariigis, nõuavad, et ostudokumendile tuleb esitada [maksustatavate](emea-cze-vat-declaration-tax-declaration-model.md#vat-control-statement) tarnete kuupäev. See kuupäev tuleb esitada, et maksuametid saaksid ühitada käibemaksuaruandluse osapoolte vahel.

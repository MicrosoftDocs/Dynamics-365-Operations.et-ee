...
3. Ridade lisamiseks kasutage valikut **Lisa** rida. Eelarveplaani dokumendi paigutuse konfiguratsiooni kuvamiseks klõpsake valikut **Paigutused**. 
   ...
   [![Eelarveplaanide lisa.](./media/bpt2-1024x274.png)](./media/bpt2.png) 
...
> [!NOTE] 
> Et vältida potentsiaalseid probleeme eelarveplaani andmete vaatamisel ja redigeerimisel Exceli abil, Microsoft Dynamics peaks sama kasutaja olema sisse logitud nii 365 Finantsi Microsoft Dynamics kui office'i lisandmooduli Data Connectori.

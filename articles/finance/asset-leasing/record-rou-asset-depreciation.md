...
description: See artikkel selgitab, kuidas luua töölehe kirje amortiseerimiseks, mida nõutakse rendide jaoks, mida tunnustatakse organisatsiooni bilansis.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
Organisatsiooni bilansis tuvastatud rentide korral, amortiseeritakse kasutamisõiguse esemeks olevat vara igakuiselt. See artikkel selgitab, kuidas luua kulumi jaoks töölehe kirjet. Amortisatsioon debiteerib pearaamatu kulukonto ja krediteerib pearaamatu akumuleeritud kulumi konto vastavalt sisestusprofiili seadistusele ja rendi tüübile. Neid kirjeid saab luua iga rendilepingu jaoks või luua mitmele rendilepingule, kasutades pakett-töölehe funktsiooni.
...
1. Valige **Rendi kokkuvõtte** lehel rendileping. Seejärel valige **Raamatud \> Vara kulumigraafik**, et avada leht **Vara kulumigraafik**.
    ...
    Kasutamisõiguse esemeks oleva vara kulumi töölehe kirje põhineb veerus **Kulumi kulu** oleval summal. Raamatupidamisstandardi vastavuse [juhendi näiteid vt jaotisest "Finantsrendide põhivara amortiseerimiskulu arvutamine" (selles artiklis](#calculation-of-rou-asset-amortization-expense-for-finance-leases)).

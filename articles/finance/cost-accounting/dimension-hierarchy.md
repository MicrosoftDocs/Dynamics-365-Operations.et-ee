...
description: See artikkel annab teavet dimensioonihierarhiate kohta. Dimensioonihierarhiat saab kasutada aruandlusstruktuuri, kulupoliitikate ja turbeseadistuse määratlemiseks kuluarvestuses.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848631"
---
# <a name="dimension-hierarchy"></a>Dimensioonihierarhia

[!include [banner](../includes/banner.md)]

See artikkel annab teavet dimensioonihierarhiate kohta. Dimensioonihierarhiat saab kasutada aruandlusstruktuuri, kulupoliitikate ja turbeseadistuse määratlemiseks kuluarvestuses.  

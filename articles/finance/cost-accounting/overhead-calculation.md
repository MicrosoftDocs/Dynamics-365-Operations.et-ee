...
-   <span data-ttu-id="1ced5-109">Üür</span><span class="sxs-lookup"><span data-stu-id="1ced5-109">Rent</span></span>
...
<span data-ttu-id="1ced5-131">[![Üldkulude arvutus](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span><span class="sxs-lookup"><span data-stu-id="1ced5-131">[![Overhead calculation](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span></span>
...
### <a name="step-1-process-the-cost-behavior-calculation"></a><span data-ttu-id="1ced5-148">1. etapp: kulukäitumise arvutuse töötlemine</span><span class="sxs-lookup"><span data-stu-id="1ced5-148">Step 1: Process the cost behavior calculation</span></span>
...
<td><span data-ttu-id="1ced5-167">2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-167">2017</span></span></td>
...
##### <a name="cost-entries"></a><span data-ttu-id="1ced5-183">Kulukirjed</span><span class="sxs-lookup"><span data-stu-id="1ced5-183">Cost entries</span></span>
...
<td><span data-ttu-id="1ced5-208">1 000,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-208">1,000.00</span></span></td>
...
<span data-ttu-id="1ced5-259">Fikseeritud kulu tuleb jaotada ühtlaselt üksikutele kuluobjektidele, mis on tarbinud elektrit.</span><span class="sxs-lookup"><span data-stu-id="1ced5-259">The fixed cost should be distributed evenly to the individual cost objects that have consumed electricity.</span></span> <span data-ttu-id="1ced5-260">Selle tulemuse saate, kasutades valemi eraldamisaluses statistilise dimensiooni liiget Elekter: (Elekter &gt; 0,00). Järgmises tabelis on näidatud tulemus, kui elektritarbimist rakendatakse muutuvkulude puhul eraldamisalusena.</span><span class="sxs-lookup"><span data-stu-id="1ced5-260">You can achieve this result by using the Electricity statistical dimension member in a formula allocation base: (Electricity &gt; 0.00) The following table shows the result when electricity consumption is applied as an allocation base for variable costs.</span></span>
...
<td><span data-ttu-id="1ced5-282">(0 ÷ 2) × 1.000,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-282">(0 ÷ 2) × 1,000.00</span></span></td>
...
<td><span data-ttu-id="1ced5-324">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-324">Electricity</span></span></td>
...
<td><span data-ttu-id="1ced5-352">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-352">Electricity</span></span></td>
...
<td><span data-ttu-id="1ced5-388">1</span><span class="sxs-lookup"><span data-stu-id="1ced5-388">1</span></span></td>
...
##### <a name="journal"></a><span data-ttu-id="1ced5-408">Tööleht</span><span class="sxs-lookup"><span data-stu-id="1ced5-408">Journal</span></span>
...
<td><span data-ttu-id="1ced5-450">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-450">January 31, 2017</span></span></td>
</tr>
<tr>
...
<tr>
<td><span data-ttu-id="1ced5-487">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-487">CC004</span></span></td>
...
<td><span data-ttu-id="1ced5-541">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-541">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-542">10</span><span class="sxs-lookup"><span data-stu-id="1ced5-542">10</span></span></td>
<td><span data-ttu-id="1ced5-543">(10 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-543">(10 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="1ced5-544">50,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-544">50.00</span></span></td>
<td><span data-ttu-id="1ced5-545">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-545">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-546">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-546">CC002</span></span></td>
<td><span data-ttu-id="1ced5-547">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-547">Finance</span></span></td>
<td><span data-ttu-id="1ced5-548">35</span><span class="sxs-lookup"><span data-stu-id="1ced5-548">35</span></span></td>
<td><span data-ttu-id="1ced5-549">(35 ÷ 100) × 1245,71</span><span class="sxs-lookup"><span data-stu-id="1ced5-549">(35 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="1ced5-550">436.00</span><span class="sxs-lookup"><span data-stu-id="1ced5-550">436.00</span></span></td>
<td><span data-ttu-id="1ced5-551">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-551">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-552">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-552">CC003</span></span></td>
<td><span data-ttu-id="1ced5-553">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-553">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-554">55</span><span class="sxs-lookup"><span data-stu-id="1ced5-554">55</span></span></td>
<td><span data-ttu-id="1ced5-555">(55 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="1ced5-555">(55 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="1ced5-556">685.14</span><span class="sxs-lookup"><span data-stu-id="1ced5-556">685.14</span></span></td>
<td><span data-ttu-id="1ced5-557">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-557">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-558">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-558">CC004</span></span></td>
<td><span data-ttu-id="1ced5-559">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-559">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-560">10</span><span class="sxs-lookup"><span data-stu-id="1ced5-560">10</span></span></td>
<td><span data-ttu-id="1ced5-561">(10 ÷ 100) × 1.245,71</span><span class="sxs-lookup"><span data-stu-id="1ced5-561">(10 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="1ced5-562">124.57</span><span class="sxs-lookup"><span data-stu-id="1ced5-562">124.57</span></span></td>
<td><span data-ttu-id="1ced5-563">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-563">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="1ced5-564">Järgmises tabelis on näidatud tulemus, kui Rahandusteenused on rakendatud kogukulu puhul eraldamisalusena (fikseeritud ja muutuvkulu).</span><span class="sxs-lookup"><span data-stu-id="1ced5-564">The following table shows the result when the Finance services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="1ced5-565">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-565">Cost object</span></span></th>
<th><span data-ttu-id="1ced5-566">Väärtus</span><span class="sxs-lookup"><span data-stu-id="1ced5-566">Magnitude</span></span></th>
<th><span data-ttu-id="1ced5-567">Eraldamistegur</span><span class="sxs-lookup"><span data-stu-id="1ced5-567">Allocation factor</span></span></th>
<th><span data-ttu-id="1ced5-568">Summa</span><span class="sxs-lookup"><span data-stu-id="1ced5-568">Amount</span></span></th>
<th><span data-ttu-id="1ced5-569">Kulukäitumine</span><span class="sxs-lookup"><span data-stu-id="1ced5-569">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-570">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-570">CC003</span></span></td>
<td><span data-ttu-id="1ced5-571">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-571">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-572">65</span><span class="sxs-lookup"><span data-stu-id="1ced5-572">65</span></span></td>
<td><span data-ttu-id="1ced5-573">(65 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="1ced5-573">(65 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="1ced5-574">438.75</span><span class="sxs-lookup"><span data-stu-id="1ced5-574">438.75</span></span></td>
<td><span data-ttu-id="1ced5-575">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-575">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-576">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-576">CC004</span></span></td>
<td><span data-ttu-id="1ced5-577">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-577">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-578">35</span><span class="sxs-lookup"><span data-stu-id="1ced5-578">35</span></span></td>
<td><span data-ttu-id="1ced5-579">(35 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="1ced5-579">(35 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="1ced5-580">236.25</span><span class="sxs-lookup"><span data-stu-id="1ced5-580">236.25</span></span></td>
<td><span data-ttu-id="1ced5-581">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-581">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-582">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-582">CC003</span></span></td>
<td><span data-ttu-id="1ced5-583">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-583">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-584">65</span><span class="sxs-lookup"><span data-stu-id="1ced5-584">65</span></span></td>
<td><span data-ttu-id="1ced5-585">(65 ÷ 100) × (7714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="1ced5-585">(65 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="1ced5-586">5,297.69</span><span class="sxs-lookup"><span data-stu-id="1ced5-586">5,297.69</span></span></td>
<td><span data-ttu-id="1ced5-587">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-587">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-588">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-588">CC004</span></span></td>
<td><span data-ttu-id="1ced5-589">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-589">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-590">35</span><span class="sxs-lookup"><span data-stu-id="1ced5-590">35</span></span></td>
<td><span data-ttu-id="1ced5-591">(35 ÷ 100) × (7714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="1ced5-591">(35 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="1ced5-592">2,852.60</span><span class="sxs-lookup"><span data-stu-id="1ced5-592">2,852.60</span></span></td>
<td><span data-ttu-id="1ced5-593">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-593">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="1ced5-594">Järgmises tabelis on näidatud tulemus, kui Assembleriteenused on rakendatud kogukulu puhul eraldamisalusena (fikseeritud ja muutuvkulu).</span><span class="sxs-lookup"><span data-stu-id="1ced5-594">The following table shows the result when the Assembly services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="1ced5-595">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-595">Cost object</span></span></th>
<th><span data-ttu-id="1ced5-596">Väärtus</span><span class="sxs-lookup"><span data-stu-id="1ced5-596">Magnitude</span></span></th>
<th><span data-ttu-id="1ced5-597">Eraldamistegur</span><span class="sxs-lookup"><span data-stu-id="1ced5-597">Allocation factor</span></span></th>
<th><span data-ttu-id="1ced5-598">Summa</span><span class="sxs-lookup"><span data-stu-id="1ced5-598">Amount</span></span></th>
<th><span data-ttu-id="1ced5-599">Kulukäitumine</span><span class="sxs-lookup"><span data-stu-id="1ced5-599">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-600">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-600">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-601">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-601">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-602">60</span><span class="sxs-lookup"><span data-stu-id="1ced5-602">60</span></span></td>
<td><span data-ttu-id="1ced5-603">(60 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="1ced5-603">(60 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="1ced5-604">535.31</span><span class="sxs-lookup"><span data-stu-id="1ced5-604">535.31</span></span></td>
<td><span data-ttu-id="1ced5-605">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-605">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-606">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-606">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-607">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-607">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-608">20</span><span class="sxs-lookup"><span data-stu-id="1ced5-608">20</span></span></td>
<td><span data-ttu-id="1ced5-609">(20 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="1ced5-609">(20 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="1ced5-610">178.44</span><span class="sxs-lookup"><span data-stu-id="1ced5-610">178.44</span></span></td>
<td><span data-ttu-id="1ced5-611">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-611">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-612">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-612">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-613">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-613">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-614">60</span><span class="sxs-lookup"><span data-stu-id="1ced5-614">60</span></span></td>
<td><span data-ttu-id="1ced5-615">(60 ÷ 80) × (5297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="1ced5-615">(60 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="1ced5-616">4,487.12</span><span class="sxs-lookup"><span data-stu-id="1ced5-616">4,487.12</span></span></td>
<td><span data-ttu-id="1ced5-617">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-617">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-618">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-618">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-619">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-619">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-620">20</span><span class="sxs-lookup"><span data-stu-id="1ced5-620">20</span></span></td>
<td><span data-ttu-id="1ced5-621">(20 ÷ 80) × (5297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="1ced5-621">(20 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="1ced5-622">1,495.71</span><span class="sxs-lookup"><span data-stu-id="1ced5-622">1,495.71</span></span></td>
<td><span data-ttu-id="1ced5-623">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-623">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="1ced5-624">Järgmises tabelis on näidatud tulemus, kui Pakendamisteenused on rakendatud kogukulu puhul eraldamisalusena (fikseeritud ja muutuvkulu).</span><span class="sxs-lookup"><span data-stu-id="1ced5-624">The following table shows the result when the Packaging services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="1ced5-625">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-625">Cost object</span></span></th>
<th><span data-ttu-id="1ced5-626">Väärtus</span><span class="sxs-lookup"><span data-stu-id="1ced5-626">Magnitude</span></span></th>
<th><span data-ttu-id="1ced5-627">Eraldamistegur</span><span class="sxs-lookup"><span data-stu-id="1ced5-627">Allocation factor</span></span></th>
<th><span data-ttu-id="1ced5-628">Summa</span><span class="sxs-lookup"><span data-stu-id="1ced5-628">Amount</span></span></th>
<th><span data-ttu-id="1ced5-629">Kulukäitumine</span><span class="sxs-lookup"><span data-stu-id="1ced5-629">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-630">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-630">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-631">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-631">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-632">80</span><span class="sxs-lookup"><span data-stu-id="1ced5-632">80</span></span></td>
<td><span data-ttu-id="1ced5-633">(80 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="1ced5-633">(80 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="1ced5-634">241.05</span><span class="sxs-lookup"><span data-stu-id="1ced5-634">241.05</span></span></td>
<td><span data-ttu-id="1ced5-635">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-635">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-636">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-636">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-637">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-637">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-638">15</span><span class="sxs-lookup"><span data-stu-id="1ced5-638">15</span></span></td>
<td><span data-ttu-id="1ced5-639">(15 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="1ced5-639">(15 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="1ced5-640">45.20</span><span class="sxs-lookup"><span data-stu-id="1ced5-640">45.20</span></span></td>
<td><span data-ttu-id="1ced5-641">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-641">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-642">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-642">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-643">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-643">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-644">80</span><span class="sxs-lookup"><span data-stu-id="1ced5-644">80</span></span></td>
<td><span data-ttu-id="1ced5-645">(80 ÷ 95) × (2852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="1ced5-645">(80 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="1ced5-646">2,507.09</span><span class="sxs-lookup"><span data-stu-id="1ced5-646">2,507.09</span></span></td>
<td><span data-ttu-id="1ced5-647">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-647">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-648">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-648">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-649">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-649">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-650">15</span><span class="sxs-lookup"><span data-stu-id="1ced5-650">15</span></span></td>
<td><span data-ttu-id="1ced5-651">(15 ÷ 95) × (2852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="1ced5-651">(15 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="1ced5-652">470.08</span><span class="sxs-lookup"><span data-stu-id="1ced5-652">470.08</span></span></td>
<td><span data-ttu-id="1ced5-653">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-653">Variable cost</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-entries-cost-object-balance-journal-entries"></a><span data-ttu-id="1ced5-654">Töölehe sisestused (kuluobjekti saldo töölehe sisestused)</span><span class="sxs-lookup"><span data-stu-id="1ced5-654">Journal entries (cost object balance journal entries)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="1ced5-655">Tööleht</span><span class="sxs-lookup"><span data-stu-id="1ced5-655">Journal</span></span></th>
<th><span data-ttu-id="1ced5-656">Töölehe tüüp</span><span class="sxs-lookup"><span data-stu-id="1ced5-656">Journal type</span></span></th>
<th colspan="3"><span data-ttu-id="1ced5-657">Rahanduskalendri periood</span><span class="sxs-lookup"><span data-stu-id="1ced5-657">Fiscal calendar period</span></span></th>
<th><span data-ttu-id="1ced5-658">Versioon</span><span class="sxs-lookup"><span data-stu-id="1ced5-658">Version</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-659">00004</span><span class="sxs-lookup"><span data-stu-id="1ced5-659">00004</span></span></td>
<td><span data-ttu-id="1ced5-660">Kulueralduse tööleht</span><span class="sxs-lookup"><span data-stu-id="1ced5-660">Cost allocation journal</span></span></td>
<td><span data-ttu-id="1ced5-661">Fiskaalne</span><span class="sxs-lookup"><span data-stu-id="1ced5-661">Fiscal</span></span></td>
<td><span data-ttu-id="1ced5-662">2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-662">2017</span></span></td>
<td><span data-ttu-id="1ced5-663">Periood 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-663">Period 1</span></span></td>
<td><span data-ttu-id="1ced5-664">Üldkulude arvutus / 01-02-2017 23:51:00 / Pearaamat /2017 / 1. periood</span><span class="sxs-lookup"><span data-stu-id="1ced5-664">Overhead calculation / 01-02-2017 11:51:00 PM / Ledger /2017 / Period 1</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-lines"></a><span data-ttu-id="1ced5-665">Töölehe read</span><span class="sxs-lookup"><span data-stu-id="1ced5-665">Journal lines</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="1ced5-666">Aruandluskuupäev</span><span class="sxs-lookup"><span data-stu-id="1ced5-666">Accounting date</span></span></th>
<th colspan="2"><span data-ttu-id="1ced5-667">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-667">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="1ced5-668">Kuluelement</span><span class="sxs-lookup"><span data-stu-id="1ced5-668">Cost element</span></span></th>
<th><span data-ttu-id="1ced5-669">Kulukäitumine</span><span class="sxs-lookup"><span data-stu-id="1ced5-669">Cost behavior</span></span></th>
<th><span data-ttu-id="1ced5-670">Summa</span><span class="sxs-lookup"><span data-stu-id="1ced5-670">Amount</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-671">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-671">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-672">CC001</span><span class="sxs-lookup"><span data-stu-id="1ced5-672">CC001</span></span></td>
<td><span data-ttu-id="1ced5-673">Personaliosakond</span><span class="sxs-lookup"><span data-stu-id="1ced5-673">HR</span></span></td>
<td><span data-ttu-id="1ced5-674">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-674">10001</span></span></td>
<td><span data-ttu-id="1ced5-675">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-675">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-676">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-676">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-677">500,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-677">500.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-678">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-678">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-679">CC001</span><span class="sxs-lookup"><span data-stu-id="1ced5-679">CC001</span></span></td>
<td><span data-ttu-id="1ced5-680">Personaliosakond</span><span class="sxs-lookup"><span data-stu-id="1ced5-680">HR</span></span></td>
<td><span data-ttu-id="1ced5-681">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-681">10001</span></span></td>
<td><span data-ttu-id="1ced5-682">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-682">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-683">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-683">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-684">1,245.71</span><span class="sxs-lookup"><span data-stu-id="1ced5-684">1,245.71</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-685">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-685">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-686">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-686">CC002</span></span></td>
<td><span data-ttu-id="1ced5-687">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-687">Finance</span></span></td>
<td><span data-ttu-id="1ced5-688">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-688">10001</span></span></td>
<td><span data-ttu-id="1ced5-689">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-689">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-690">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-690">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-691">675.00</span><span class="sxs-lookup"><span data-stu-id="1ced5-691">675.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-692">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-692">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-693">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-693">CC002</span></span></td>
<td><span data-ttu-id="1ced5-694">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-694">Finance</span></span></td>
<td><span data-ttu-id="1ced5-695">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-695">10001</span></span></td>
<td><span data-ttu-id="1ced5-696">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-696">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-697">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-697">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-698">8,150.29</span><span class="sxs-lookup"><span data-stu-id="1ced5-698">8,150.29</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-699">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-699">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-700">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-700">CC003</span></span></td>
<td><span data-ttu-id="1ced5-701">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-701">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-702">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-702">10001</span></span></td>
<td><span data-ttu-id="1ced5-703">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-703">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-704">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-704">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-705">713.75</span><span class="sxs-lookup"><span data-stu-id="1ced5-705">713.75</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-706">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-706">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-707">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-707">CC003</span></span></td>
<td><span data-ttu-id="1ced5-708">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-708">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-709">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-709">10001</span></span></td>
<td><span data-ttu-id="1ced5-710">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-710">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-711">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-711">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-712">5,982.83</span><span class="sxs-lookup"><span data-stu-id="1ced5-712">5,982.83</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-713">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-713">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-714">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-714">CC003</span></span></td>
<td><span data-ttu-id="1ced5-715">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-715">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-716">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-716">10001</span></span></td>
<td><span data-ttu-id="1ced5-717">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-717">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-718">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-718">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-719">286.25</span><span class="sxs-lookup"><span data-stu-id="1ced5-719">286.25</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-720">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-720">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-721">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-721">CC003</span></span></td>
<td><span data-ttu-id="1ced5-722">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-722">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-723">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-723">10001</span></span></td>
<td><span data-ttu-id="1ced5-724">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-724">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-725">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-725">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-726">2,977.17</span><span class="sxs-lookup"><span data-stu-id="1ced5-726">2,977.17</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-727">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-727">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-728">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-728">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-729">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-729">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-730">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-730">10001</span></span></td>
<td><span data-ttu-id="1ced5-731">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-731">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-732">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-732">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-733">776.36</span><span class="sxs-lookup"><span data-stu-id="1ced5-733">776.36</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-734">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-734">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-735">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-735">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-736">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-736">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-737">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-737">10001</span></span></td>
<td><span data-ttu-id="1ced5-738">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-738">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-739">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-739">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-740">6,994.21</span><span class="sxs-lookup"><span data-stu-id="1ced5-740">6,994.21</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-741">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-741">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-742">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-742">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-743">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-743">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-744">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-744">10001</span></span></td>
<td><span data-ttu-id="1ced5-745">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-745">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-746">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-746">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-747">223.64</span><span class="sxs-lookup"><span data-stu-id="1ced5-747">223.64</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-748">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-748">January 31, 2017</span></span></td>
<td><span data-ttu-id="1ced5-749">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-749">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-750">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-750">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-751">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-751">10001</span></span></td>
<td><span data-ttu-id="1ced5-752">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-752">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-753">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-753">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-754">1,965.79</span><span class="sxs-lookup"><span data-stu-id="1ced5-754">1,965.79</span></span></td>
</tr>
</tbody>
</table>

##### <a name="cost-entries"></a><span data-ttu-id="1ced5-755">Kulukirjed</span><span class="sxs-lookup"><span data-stu-id="1ced5-755">Cost entries</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="1ced5-756">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-756">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="1ced5-757">Kuluelement</span><span class="sxs-lookup"><span data-stu-id="1ced5-757">Cost element</span></span></th>
<th><span data-ttu-id="1ced5-758">Kulukäitumine</span><span class="sxs-lookup"><span data-stu-id="1ced5-758">Cost behavior</span></span></th>
<th><span data-ttu-id="1ced5-759">Summa</span><span class="sxs-lookup"><span data-stu-id="1ced5-759">Amount</span></span></th>
<th><span data-ttu-id="1ced5-760">Aruandluskuupäev</span><span class="sxs-lookup"><span data-stu-id="1ced5-760">Accounting date</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="1ced5-761">CC001</span><span class="sxs-lookup"><span data-stu-id="1ced5-761">CC001</span></span></td>
<td><span data-ttu-id="1ced5-762">Personaliosakond</span><span class="sxs-lookup"><span data-stu-id="1ced5-762">HR</span></span></td>
<td><span data-ttu-id="1ced5-763">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-763">10001</span></span></td>
<td><span data-ttu-id="1ced5-764">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-764">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-765">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-765">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-766">‑500,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-766">-500.00</span></span></td>
<td><span data-ttu-id="1ced5-767">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-767">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-768">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-768">CC002</span></span></td>
<td><span data-ttu-id="1ced5-769">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-769">Finance</span></span></td>
<td><span data-ttu-id="1ced5-770">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-770">10001</span></span></td>
<td><span data-ttu-id="1ced5-771">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-771">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-772">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-772">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-773">175.00</span><span class="sxs-lookup"><span data-stu-id="1ced5-773">175.00</span></span></td>
<td><span data-ttu-id="1ced5-774">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-774">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-775">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-775">CC003</span></span></td>
<td><span data-ttu-id="1ced5-776">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-776">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-777">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-777">10001</span></span></td>
<td><span data-ttu-id="1ced5-778">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-778">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-779">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-779">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-780">275.00</span><span class="sxs-lookup"><span data-stu-id="1ced5-780">275.00</span></span></td>
<td><span data-ttu-id="1ced5-781">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-781">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-782">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-782">CC004</span></span></td>
<td><span data-ttu-id="1ced5-783">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-783">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-784">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-784">10001</span></span></td>
<td><span data-ttu-id="1ced5-785">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-785">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-786">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-786">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-787">50,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-787">50,00</span></span></td>
<td><span data-ttu-id="1ced5-788">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-788">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-789">CC001</span><span class="sxs-lookup"><span data-stu-id="1ced5-789">CC001</span></span></td>
<td><span data-ttu-id="1ced5-790">Personaliosakond</span><span class="sxs-lookup"><span data-stu-id="1ced5-790">HR</span></span></td>
<td><span data-ttu-id="1ced5-791">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-791">10001</span></span></td>
<td><span data-ttu-id="1ced5-792">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-792">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-793">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-793">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-794">–1245,71</span><span class="sxs-lookup"><span data-stu-id="1ced5-794">-1,245.71</span></span></td>
<td><span data-ttu-id="1ced5-795">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-795">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-796">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-796">CC002</span></span></td>
<td><span data-ttu-id="1ced5-797">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-797">Finance</span></span></td>
<td><span data-ttu-id="1ced5-798">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-798">10001</span></span></td>
<td><span data-ttu-id="1ced5-799">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-799">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-800">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-800">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-801">436.00</span><span class="sxs-lookup"><span data-stu-id="1ced5-801">436.00</span></span></td>
<td><span data-ttu-id="1ced5-802">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-802">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-803">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-803">CC003</span></span></td>
<td><span data-ttu-id="1ced5-804">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-804">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-805">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-805">10001</span></span></td>
<td><span data-ttu-id="1ced5-806">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-806">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-807">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-807">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-808">685.14</span><span class="sxs-lookup"><span data-stu-id="1ced5-808">685.14</span></span></td>
<td><span data-ttu-id="1ced5-809">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-809">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-810">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-810">CC004</span></span></td>
<td><span data-ttu-id="1ced5-811">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-811">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-812">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-812">10001</span></span></td>
<td><span data-ttu-id="1ced5-813">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-813">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-814">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-814">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-815">124.57</span><span class="sxs-lookup"><span data-stu-id="1ced5-815">124.57</span></span></td>
<td><span data-ttu-id="1ced5-816">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-816">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-817">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-817">CC002</span></span></td>
<td><span data-ttu-id="1ced5-818">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-818">Finance</span></span></td>
<td><span data-ttu-id="1ced5-819">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-819">10001</span></span></td>
<td><span data-ttu-id="1ced5-820">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-820">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-821">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-821">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-822">–675,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-822">-675.00</span></span></td>
<td><span data-ttu-id="1ced5-823">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-823">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-824">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-824">CC003</span></span></td>
<td><span data-ttu-id="1ced5-825">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-825">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-826">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-826">10001</span></span></td>
<td><span data-ttu-id="1ced5-827">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-827">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-828">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-828">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-829">438.75</span><span class="sxs-lookup"><span data-stu-id="1ced5-829">438.75</span></span></td>
<td><span data-ttu-id="1ced5-830">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-830">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-831">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-831">CC004</span></span></td>
<td><span data-ttu-id="1ced5-832">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-832">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-833">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-833">10001</span></span></td>
<td><span data-ttu-id="1ced5-834">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-834">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-835">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-835">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-836">236.25</span><span class="sxs-lookup"><span data-stu-id="1ced5-836">236.25</span></span></td>
<td><span data-ttu-id="1ced5-837">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-837">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-838">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-838">CC002</span></span></td>
<td><span data-ttu-id="1ced5-839">Finantsid</span><span class="sxs-lookup"><span data-stu-id="1ced5-839">Finance</span></span></td>
<td><span data-ttu-id="1ced5-840">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-840">10001</span></span></td>
<td><span data-ttu-id="1ced5-841">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-841">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-842">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-842">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-843">–8150,29</span><span class="sxs-lookup"><span data-stu-id="1ced5-843">-8,150.29</span></span></td>
<td><span data-ttu-id="1ced5-844">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-844">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-845">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-845">CC003</span></span></td>
<td><span data-ttu-id="1ced5-846">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-846">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-847">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-847">10001</span></span></td>
<td><span data-ttu-id="1ced5-848">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-848">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-849">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-849">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-850">5,297.69</span><span class="sxs-lookup"><span data-stu-id="1ced5-850">5,297.69</span></span></td>
<td><span data-ttu-id="1ced5-851">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-851">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-852">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-852">CC004</span></span></td>
<td><span data-ttu-id="1ced5-853">Pakendamine</span><span class="sxs-lookup"><span data-stu-id="1ced5-853">Packaging</span></span></td>
<td><span data-ttu-id="1ced5-854">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-854">10001</span></span></td>
<td><span data-ttu-id="1ced5-855">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-855">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-856">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-856">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-857">2,852.60</span><span class="sxs-lookup"><span data-stu-id="1ced5-857">2,852.60</span></span></td>
<td><span data-ttu-id="1ced5-858">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-858">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-859">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-859">CC003</span></span></td>
<td><span data-ttu-id="1ced5-860">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-860">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-861">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-861">10001</span></span></td>
<td><span data-ttu-id="1ced5-862">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-862">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-863">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-863">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-864">–713,75</span><span class="sxs-lookup"><span data-stu-id="1ced5-864">-713.75</span></span></td>
<td><span data-ttu-id="1ced5-865">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-865">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-866">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-866">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-867">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-867">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-868">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-868">10001</span></span></td>
<td><span data-ttu-id="1ced5-869">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-869">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-870">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-870">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-871">535.31</span><span class="sxs-lookup"><span data-stu-id="1ced5-871">535.31</span></span></td>
<td><span data-ttu-id="1ced5-872">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-872">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-873">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-873">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-874">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-874">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-875">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-875">10001</span></span></td>
<td><span data-ttu-id="1ced5-876">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-876">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-877">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-877">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-878">178.44</span><span class="sxs-lookup"><span data-stu-id="1ced5-878">178.44</span></span></td>
<td><span data-ttu-id="1ced5-879">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-879">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-880">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-880">CC003</span></span></td>
<td><span data-ttu-id="1ced5-881">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-881">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-882">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-882">10001</span></span></td>
<td><span data-ttu-id="1ced5-883">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-883">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-884">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-884">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-885">–5982,83</span><span class="sxs-lookup"><span data-stu-id="1ced5-885">-5,982.83</span></span></td>
<td><span data-ttu-id="1ced5-886">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-886">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-887">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-887">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-888">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-888">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-889">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-889">10001</span></span></td>
<td><span data-ttu-id="1ced5-890">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-890">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-891">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-891">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-892">4,487.12</span><span class="sxs-lookup"><span data-stu-id="1ced5-892">4,487.12</span></span></td>
<td><span data-ttu-id="1ced5-893">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-893">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-894">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-894">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-895">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-895">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-896">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-896">10001</span></span></td>
<td><span data-ttu-id="1ced5-897">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-897">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-898">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-898">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-899">1,495.71</span><span class="sxs-lookup"><span data-stu-id="1ced5-899">1,495.71</span></span></td>
<td><span data-ttu-id="1ced5-900">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-900">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-901">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-901">CC003</span></span></td>
<td><span data-ttu-id="1ced5-902">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-902">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-903">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-903">10001</span></span></td>
<td><span data-ttu-id="1ced5-904">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-904">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-905">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-905">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-906">–286,25</span><span class="sxs-lookup"><span data-stu-id="1ced5-906">-286.25</span></span></td>
<td><span data-ttu-id="1ced5-907">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-907">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-908">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-908">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-909">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-909">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-910">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-910">10001</span></span></td>
<td><span data-ttu-id="1ced5-911">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-911">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-912">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-912">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-913">241.05</span><span class="sxs-lookup"><span data-stu-id="1ced5-913">241.05</span></span></td>
<td><span data-ttu-id="1ced5-914">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-914">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-915">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-915">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-916">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-916">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-917">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-917">10001</span></span></td>
<td><span data-ttu-id="1ced5-918">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-918">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-919">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-919">Fixed cost</span></span></td>
<td><span data-ttu-id="1ced5-920">45.20</span><span class="sxs-lookup"><span data-stu-id="1ced5-920">45.20</span></span></td>
<td><span data-ttu-id="1ced5-921">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-921">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-922">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-922">CC003</span></span></td>
<td><span data-ttu-id="1ced5-923">Assembler</span><span class="sxs-lookup"><span data-stu-id="1ced5-923">Assembly</span></span></td>
<td><span data-ttu-id="1ced5-924">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-924">10001</span></span></td>
<td><span data-ttu-id="1ced5-925">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-925">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-926">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-926">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-927">–2977,17</span><span class="sxs-lookup"><span data-stu-id="1ced5-927">-2,977.17</span></span></td>
<td><span data-ttu-id="1ced5-928">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-928">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-929">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-929">Prod 1</span></span></td>
<td><span data-ttu-id="1ced5-930">Toode 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-930">Product 1</span></span></td>
<td><span data-ttu-id="1ced5-931">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-931">10001</span></span></td>
<td><span data-ttu-id="1ced5-932">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-932">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-933">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-933">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-934">2,507.09</span><span class="sxs-lookup"><span data-stu-id="1ced5-934">2,507.09</span></span></td>
<td><span data-ttu-id="1ced5-935">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-935">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="1ced5-936">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-936">Prod 2</span></span></td>
<td><span data-ttu-id="1ced5-937">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-937">Product 2</span></span></td>
<td><span data-ttu-id="1ced5-938">10001</span><span class="sxs-lookup"><span data-stu-id="1ced5-938">10001</span></span></td>
<td><span data-ttu-id="1ced5-939">Elektrienergia</span><span class="sxs-lookup"><span data-stu-id="1ced5-939">Electricity</span></span></td>
<td><span data-ttu-id="1ced5-940">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-940">Variable cost</span></span></td>
<td><span data-ttu-id="1ced5-941">470.08</span><span class="sxs-lookup"><span data-stu-id="1ced5-941">470.08</span></span></td>
<td><span data-ttu-id="1ced5-942">31. jaanuar 2017</span><span class="sxs-lookup"><span data-stu-id="1ced5-942">January 31, 2017</span></span></td>
</tr>
</tbody>
</table>

## <a name="conclusion"></a><span data-ttu-id="1ced5-943">Lõppsõna</span><span class="sxs-lookup"><span data-stu-id="1ced5-943">Conclusion</span></span>
<span data-ttu-id="1ced5-944">Finantsaruandluses sisestatakse elektrikulu 10 000,00 fiktiivse kulukeskuse ID-le.</span><span class="sxs-lookup"><span data-stu-id="1ced5-944">In Financial accounting, a cost of 10,000.00 for Electricity is posted to a dummy cost center ID.</span></span> <span data-ttu-id="1ced5-945">Nii teavad kuluarvestajad, et see kulu tuleb eraldada.</span><span class="sxs-lookup"><span data-stu-id="1ced5-945">Therefore, cost accountants will know that this cost must be allocated.</span></span> <span data-ttu-id="1ced5-946">Kuluarvestuses liigub kulu rakendatud poliitikate ja reeglite põhjal läbi organisatsiooniüksuste ja -tasemete.</span><span class="sxs-lookup"><span data-stu-id="1ced5-946">In Cost accounting, the costs flow across organizational units and levels, based on the policies and rules that are applied.</span></span> <span data-ttu-id="1ced5-947">Iga kulu on seostatud eraldamisalusega, mis pakub kulude eraldamiseks parimat hinnangut.</span><span class="sxs-lookup"><span data-stu-id="1ced5-947">Each cost has been associated with an allocation base that provides the best assessment for the allocation of costs.</span></span>

<table>
<thead>
<tr>
<th colspan="2" rowspan="2"><span data-ttu-id="1ced5-948">Kuluelement</span><span class="sxs-lookup"><span data-stu-id="1ced5-948">Cost element</span></span></th>
<th colspan="9"><span data-ttu-id="1ced5-949">Kuluobjekt</span><span class="sxs-lookup"><span data-stu-id="1ced5-949">Cost object</span></span></th>
<th rowspan="2"><span data-ttu-id="1ced5-950">Kokku</span><span class="sxs-lookup"><span data-stu-id="1ced5-950">Total</span></span></th>
</tr>
<tr>
<th><span data-ttu-id="1ced5-951">CC099</span><span class="sxs-lookup"><span data-stu-id="1ced5-951">CC099</span></span></th>
<th><span data-ttu-id="1ced5-952">CC001</span><span class="sxs-lookup"><span data-stu-id="1ced5-952">CC001</span></span></th>
<th><span data-ttu-id="1ced5-953">CC002</span><span class="sxs-lookup"><span data-stu-id="1ced5-953">CC002</span></span></th>
<th><span data-ttu-id="1ced5-954">CC003</span><span class="sxs-lookup"><span data-stu-id="1ced5-954">CC003</span></span></th>
<th><span data-ttu-id="1ced5-955">CC004</span><span class="sxs-lookup"><span data-stu-id="1ced5-955">CC004</span></span></th>
<th><span data-ttu-id="1ced5-956">Proj. 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-956">Proj 1</span></span></th>
<th><span data-ttu-id="1ced5-957">Proj. 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-957">Proj 2</span></span></th>
<th><span data-ttu-id="1ced5-958">Tooe 1</span><span class="sxs-lookup"><span data-stu-id="1ced5-958">Prod 1</span></span></th>
<th><span data-ttu-id="1ced5-959">Toode 2</span><span class="sxs-lookup"><span data-stu-id="1ced5-959">Prod 2</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td colspan="2"><span data-ttu-id="1ced5-960">10001 Elekter</span><span class="sxs-lookup"><span data-stu-id="1ced5-960">10001 Electricity</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-961"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-961"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-962"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-962"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-963"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-963"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-964"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-964"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-965"><strong>30,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-965"><strong>30.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-966"><strong>10,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-966"><strong>10.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-967"><strong>7.770,57</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-967"><strong>7,770.57</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-968"><strong>2.189,43</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-968"><strong>2,189.43</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-969"><strong>10.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-969"><strong>10,000.00</strong></span></span></td>
</tr>
<tr>
<td></td>
<td style="text-align: left;"><span data-ttu-id="1ced5-970">Liigitamata</span><span class="sxs-lookup"><span data-stu-id="1ced5-970">Unclassified</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-971">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-971">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
...
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="1ced5-972">Fikseeritud kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-972">Fixed cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-973">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-973">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-974">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-974">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-975">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-975">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-976">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-976">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-977">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-977">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-978">776.36</span><span class="sxs-lookup"><span data-stu-id="1ced5-978">776.36</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-979">223.64</span><span class="sxs-lookup"><span data-stu-id="1ced5-979">223.64</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-980"><strong>1.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-980"><strong>1,000.00</strong></span></span></td>
</tr>
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="1ced5-981">Muutuv kulu</span><span class="sxs-lookup"><span data-stu-id="1ced5-981">Variable cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-982">000</span><span class="sxs-lookup"><span data-stu-id="1ced5-982">000</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-983">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-983">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-984">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-984">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-985">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-985">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-986">0,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-986">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-987">30,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-987">30.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-988">10,00</span><span class="sxs-lookup"><span data-stu-id="1ced5-988">10.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-989">6,994.21</span><span class="sxs-lookup"><span data-stu-id="1ced5-989">6,994.21</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-990">1,965.79</span><span class="sxs-lookup"><span data-stu-id="1ced5-990">1,965.79</span></span></td>
<td style="text-align: right;"><span data-ttu-id="1ced5-991"><strong>9.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="1ced5-991"><strong>9,000.00</strong></span></span></td>
</tr>
</tbody>
</table>

> [!NOTE]
> <span data-ttu-id="1ced5-992">Selles teemas selgitatakse, kuidas esmane kuluelement, 10001 Eleter, liigub läbi kuluobjektide.</span><span class="sxs-lookup"><span data-stu-id="1ced5-992">This topic shows how a primary cost element, 10001 Electricity, flows through the cost objects.</span></span> <span data-ttu-id="1ced5-993">Seega eraldatakse see üldkulu organisatsiooni madalaimale tasemele.</span><span class="sxs-lookup"><span data-stu-id="1ced5-993">Therefore, this overhead cost is allocated to the lowest level in the organization.</span></span> <span data-ttu-id="1ced5-994">Teisisõnu kannavad kulu madalaimal tasemel olevad kuluobjektid.</span><span class="sxs-lookup"><span data-stu-id="1ced5-994">In other words, the cost objects at the lowest level bear the cost.</span></span> <span data-ttu-id="1ced5-995">Kui soovite saada kuluobjektide vahelisest kuluvoost visuaalset ülevaadet, saate kuluvoo visualiseerimiseks kasutada kulude kokkuvõtte poliitika reegleid.</span><span class="sxs-lookup"><span data-stu-id="1ced5-995">If you require a visual flow of the cost between the cost objects, you can use the cost roll-up policy rules to visualize the flow of the cost.</span></span> <span data-ttu-id="1ced5-996">Lisateavet vt teemast [Kulukomplekti poliitika ja üldkulude arvutus](cost-rollup.md).</span><span class="sxs-lookup"><span data-stu-id="1ced5-996">For more information, see [Cost rollup policy and overhead calculation](cost-rollup.md).</span></span>

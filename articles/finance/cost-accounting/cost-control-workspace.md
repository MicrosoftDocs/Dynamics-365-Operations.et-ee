...
description: See artikkel annab teavet kulujuhtimise tööruumi kohta. See tööruum on keskne punkt, kus juhid, kes vastutavad kuluobjekti või kuluobjektide kogumi kontrollimise eest dimensioonis või dimensioonide lõikes, aruannetele juurde pääsevad.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''

...
description: See artikkel annab teavet TaxTransi valede väljaväärtuste tõrkeotsingu kohta.
author: EricWangChen
ms.date: 04/27/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8899810"
---
# <a name="incorrect-field-value-in-taxtrans"></a>TaxTransi välja vale väärtus

[!include [banner](../includes/banner.md)]

Kui TaxTransi **välja väärtus** on vale, kasutage probleemi lahendamiseks selle artikli teavet.

...
description: See artikkel annab üksikasjalikku teavet impordivormingu kohta, mida kasutatakse finantsandmete konsolideerimisel mitmelt juriidiliselt isikult.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8871300"
---
# <a name="import-format-for-consolidation"></a>Konsolideerimise impordivorming

[!include [banner](../includes/banner.md)]

See artikkel annab üksikasjalikku teavet impordivormingu kohta, mida kasutatakse finantsandmete konsolideerimisel mitmelt juriidiliselt isikult. Impordivorming tuleb salvestada tekstifailina (.txt).

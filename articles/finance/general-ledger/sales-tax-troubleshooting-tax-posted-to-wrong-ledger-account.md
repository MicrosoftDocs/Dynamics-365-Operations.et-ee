...
description: See artikkel pakub tõrkeotsingu teavet, mis võib aidata, kui maks sisestatakse kandes valele pearaamatukontole.
author: qire
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
Sisestamise ajal võib juhtuda, et maks sisestatakse kandes valele pearaamatukontole. Selle probleemi tõrkeotsinguks järgige vastavalt järgmistele jaotistele juhiseid. Selle artikli näidetes kasutatakse äridokumendina müügitellimust.

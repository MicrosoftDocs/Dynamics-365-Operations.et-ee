...
1. Minge inimressursside **värbamisprojektide \> värbamisprojektidesse \>\>**.
2. Valige suvand **Uus**.
3. Sisestage väärtus väljale **Värbamisprojekt**.
4. Sisestage väärtus väljal **Kirjeldus**.
5. **Otsingu avamiseks** valige väljal Värbaja rippnool.
6. Otsige loendist ja valige soovitud kirje.
7. Valige loendis link valitud reas.
8. Valige käsk **Vali**.
9. **Otsingu** avamiseks valige väljal Osakond rippnool.
10. Valige loendis link valitud reas.
11. **Otsingu** avamiseks valige väljal Töö rippnool.
12. Otsige loendist ja valige soovitud kirje.
13. Valige loendis link valitud reas.
14. **Väljale Avamiste arv** sisestage number.
15. **Otsingu avamiseks** valige väljal Palkamise haldur rippnool.
...
20. Valige **Meedium**.
    ...
    Värbamisprojektid hõlmavad valikut vabade ametikohtade reklaamimiseks kasutatavate meediakanalite täpsustamiseks.

21. Valige suvand **Uus**.
22. **Otsingu** avamiseks valige väljal Meedia rippnool.
...
30. Sulgege leht.
31. Märkige või tühjendage **ruut Kuva töötaja iseteeninduses**.

    Märkige see ruut, kui soovite, et värbamisprojekt kuvataks töötajatele nende töötajate **iseteeninduslehekülgedes**.

32. Saate valida **värbamisprojekti** oleku.
33. Valige nupp **Alusta**.

    Olek **Alustatud** näitab, et projekt on valmis avalduste saamiseks.

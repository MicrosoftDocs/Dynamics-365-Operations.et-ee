...
## <a name="stand-alone-applications"></a>Autonoomsed avaldused

Et näha, mida uus või muutub eraldi, Dynamics 365 Human Resources vaadake järgmisest artiklist:
...
## <a name="lifecycle-services-releases"></a>Teenuse Lifecycle Services väljalasked
Elutsükli teenustes uute või muutunud kaupade näeb järgmine artikkel:

- [Mis on uut või mida on muudetud teenuses Lifecycle Services (LCS)?](../../dev-itpro/lifecycle-services/whats-new-lcs.md)

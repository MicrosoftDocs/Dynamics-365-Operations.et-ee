...
description: See artikkel annab teavet arvete kinnituste mobiilse tööruumi kohta.
author: abruer
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
...
See artikkel annab teavet arvete kinnituste **mobiilse tööruumi** kohta. See tööruum annab loendi arvetest, mis on määratud teile hankija arve päise töövooprotsessi kaudu. 

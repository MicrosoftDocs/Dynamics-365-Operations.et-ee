...
See artikkel selgitab, kuidas importida ER-i konfiguratsioonide värskendatud versioone konfigureerimisteenuse globaalsest hoidlast. Lisateavet vt teemast [Microsoft Dynamics 365 for Finance and Operations – Regulatory Services, konfiguratsiooniteenus](/business-applications-release-notes/october18/dynamics365-finance-operations/regulatory-service-configuration).

...
Etappide lõpuleviimiseks peate esmalt läbima protseduuri „ER Konfiguratsiooni pakkuja loomine ja selle märkimine aktiivseks” etapid.
...
1. Avage Organisatsiooni haldamine > Tööruumid > Elektrooniline aruandlus.
    ...
    * Koostate sissetulevate pangaväljavõtete sõelumise protsessi avalduse andmete värskendamiseks. Sissetulevad pangaväljavõtted saadetakse teile TXT-failidena, mis sisaldavad IBAN-koode. Pangaväljavõtte importimise osana peate selle IBAN-koodide õigsust kontrollima loogikaga, mis on juba saadaval.   

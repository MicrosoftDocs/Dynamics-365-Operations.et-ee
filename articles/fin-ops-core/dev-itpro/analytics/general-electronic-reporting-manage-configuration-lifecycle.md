...
- <span data-ttu-id="eee96-109">Elektroonilise dokumendi malli kujundamine.</span><span class="sxs-lookup"><span data-stu-id="eee96-109">Design a template for an electronic document:</span></span>

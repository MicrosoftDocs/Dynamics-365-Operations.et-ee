...
ms.locfileid: "3019730"
---
# <a name="FileDestinationType">Faili sihtkoht</a>

[!include [banner](../includes/banner.md)]

Saate konfigureerida faili sihtkoha iga väljamineva dokumendi loomiseks konfigureeritud elektroonilise aruandluse (ER) vormingu iga kausta või faili komponendi jaoks. Sihtkoha sätte alusel on loodud dokument saadaval veebibrauserist allalaadimiseks saadaval.

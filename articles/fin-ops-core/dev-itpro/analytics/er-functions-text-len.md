...
ms.locfileid: "6768461"
---
# <a name="len-er-function"></a>ER-i funktsioon LEN

[!include [banner](../includes/banner.md)]

Funktsioon `LEN` tagastab tähemärkide arvu määratud stringis *täisarvu* väärtusena.

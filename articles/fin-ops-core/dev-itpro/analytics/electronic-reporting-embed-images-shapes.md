...
description: See artikkel selgitab, kuidas kasutada elektroonilise aruandluse tööriista äridokumentide loomiseks, milles on manustatud pilte ja kujusid.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''

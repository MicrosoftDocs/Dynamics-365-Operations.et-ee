...
Toodete topeltkirjutamise olemikaardid on loodud andmete voogesitamiseks ainult ühesuunaliselt, reaalajas Finance and Operationsi rakendustest teenusesse Common Data Service. Kuid toote infrastruktuur on tehtud avatuks, et muuta see vajadusel kahesuunaliseks. Kuid võite seda oma vastutusel kohandada, kuna Microsoft ei soovita seda lähenemist.
...
Pange tähele, et toodete sünkroonimine toimub Finance and Operationsi rakendustest teenusesse Common Data Service. See tähendab, et toote üksuse väljade väärtusi saab muuta Common Data Service’is, aga kui käivitatakse sünkroonimine (kui tootevälja muudetakse Finance and Operationsi rakenduses), alistab see väärtused Common Data Service’is. 
...
Kui topeltkirjutamine on lubatud, sünkroonitakse Finance and Operationsi rakenduste ühikud teiste Dynamics 365 rakendustega. Finance and Operationsi rakendustest Common Data Service’is sünkroonitud ühikute gruppidel on lippude komplekt, mis tähistab, et need on väliselt hallatavad.

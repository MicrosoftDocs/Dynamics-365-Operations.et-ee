---
title: Finantside ja toimingute rakenduste täiendustest väljaprobleemide tõrkeotsing
description: See artikkel pakub tõrkeotsingu teavet, mis aitab lahendada probleeme, mis on seotud finantside ja toimingute rakenduste täiendustega.
...
ms.locfileid: "9111136"
---
# <a name="troubleshoot-issues-from-upgrades-of-finance-and-operations-apps"></a>Finantside ja toimingute rakenduste täiendustest väljaprobleemide tõrkeotsing
...
See artikkel pakub tõrkeotsingu teavet topeltkirjutuse integreerimiseks finantside ja toimingute rakenduste ning Dataverse. See annab teavet, mis võib aidata teil lahendada probleeme, mis on seotud finantside ja toimingute rakenduste täiendustega.
...
Võite saada tõrketeate, **mis sarnaneb järgmise näitega, kui proovite kasutada tabelit DualWriteProjectConfiguration**, et värskendada finantside ja toimingute rakendust platvormi värskendusele 30.
...
1. Logige sisse VM-i finantside ja toimingute rakenduse jaoks.
...
3. Avage **Tööruumid \> Andmehaldus**, valige vahekaart **Andmetabelid** ja veenduge, et tabel oleks loendis toodud. Kui tabelit loendis pole, logige finantside ja toimingute rakenduse puhul VM-i sisse ja veenduge, et tabel on saadaval.
4. Avage tabeli **vastendamise** leht finantside **ja toimingute** rakenduse topeltkirjutuse lehelt.

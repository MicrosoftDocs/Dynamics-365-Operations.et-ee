## <a name="customers-v3-to-accounts"></a>Kliendi V3 kontodele

See mall sünkroonib andmeid rakenduste Finance and Operations ja Common Data Service'i vahel.

Allika filter: ((PartyType == "Organization"))

Ümber pööratud allika filter: customertypecode eq 3
...
puudub | >> | address1_addresstypecode | 2
puudub | >> | customertypecode | 3
PARTYTYPE | << | puudub | Organisatsioon

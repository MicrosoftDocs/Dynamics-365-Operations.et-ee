## <a name="vendors-v2-to-msdyn_vendors"></a>Hankijad V2 üksusele msdyn_vendors
...
AADRESSPOSTBOX | = | msdyn_addresspostbox | 
...
AADRESSSTREETINUMBER | = | msdyn_addressstreetnumber | 

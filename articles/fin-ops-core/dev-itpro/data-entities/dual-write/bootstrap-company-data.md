...
Teil võib olla olemasolev Common Data Service’i või muu Dynamics 365 rakenduse ettevõtte andmetega eksemplar ja soovite selle jaoks lubada topeltkirjutamise ühendust. Sellisel juhul peate alglaadima Common Data Service’i või muu Dynamics 365 rakenduse andmeid ettevõtte teabega enne topeltkirjutamise ühenduse lubamist.  
 
## <a name="when-should-i-use-bootstrapping"></a>Millal peaksin alglaadimist kasutama? 
Kasutage alglaadimist enne topeltkirjutamise olemikaartide lubamist (etapis 5).  
1. Finance and Operations rakenduse ja Common Data Service’i või muu Dynamics 365 rakenduse vahel topeltkirjutamise ühenduse seadistamiseks logige administraatorina sisse Finance and Operationsi rakendusse. 
...
4. Lubage olemikaart **Cdm_companies**. See sünkroonib ettevõtted rakendusest Finance and Operations rakendusse Common Data Service.  
    > [!div class="mx-imgBorder"]
    > ![Olemikaardi lubamine](media/dual-write-boot-2.png)
5. Käivitage alglaadimise näidiskood Common Data Service’is või muus Dynamics 365 rakenduse eksemplaris.  
6. Kui alglaadimine on tehtud ja süsteem on reaalajas sünkroonimiseks valmis, lubage olemikaardid.  

    Olemikaartide lubamine käivitab andmete algse sünkroonimise lubatud olemikaartide jaoks. Topeltkirjutamise ühenduses valitud ettevõtetele vastavad andmed sünkroonitakse rakenduste Finance and Operations ja Common Data Service vahel. 
 
## <a name="how-to-i-use-the-code-sample"></a>Kui kasutada näidiskoodi?
Näidiskood on C# rakendus, mille saate laadida rakenduses Visual Studio. See võtab NuGeti paketi sõltuvused Common Data Service’i SDK-s, mida saate värskendada Visual Studio standardsete tööriistadega. 

...
## <a name="why-do-i-need-bootstrapping"></a>Milleks on vaja alglaadimist? 
Teil võib olla olemasolev Dataverse’i või muu Dynamics 365 rakenduse ettevõtte andmetega eksemplar ja soovite selle jaoks lubada topeltkirjutamise ühendust. Sellisel juhul peate alglaadima Dataverse’i või muu Dynamics 365 rakenduse andmeid ettevõtte teabega enne topeltkirjutamise ühenduse lubamist.  
 
## <a name="when-should-i-use-bootstrapping"></a>Millal peaksin alglaadimist kasutama? 
Kasutage alglaadimist enne topeltkirjutamise tabeli vastenduste lubamist (etapis 5).  
1. Finance and Operations rakenduse ja Dataverse’i või muu Dynamics 365 rakenduse vahel topeltkirjutamise ühenduse seadistamiseks logige administraatorina sisse Finance and Operationsi rakendusse. 
2. Minge moodulisse **Andmehaldus** ja klõpsake nuppu **Topeltkirjutamine**. See käivitab **andmeintegraatori**. 
3. Looge topeltkirjutamise ühendus ühele või mitmele ettevõttele.  
    > [!div class="mx-imgBorder"]
    > ![Topeltkirjutamise ühenduse loomine](media/dual-write-boot-1.png)
4. Lubage tabeli vastendus **Cdm_companies**. See sünkroonib ettevõtted rakendusest Finance and Operations rakendusse Dataverse.  
    > [!div class="mx-imgBorder"]
    > ![Tabeli vastenduse lubamine](media/dual-write-boot-2.png)
5. Käivitage alglaadimise näidiskood Dataverse’is või muus Dynamics 365 rakenduse eksemplaris.  
6. Kui alglaadimine on tehtud ja süsteem on reaalajas sünkroonimiseks valmis, lubage tabeli vastendused.  

    Tabeli vastenduste lubamine käivitab andmete algse sünkroonimise lubatud tabeli vastenduste jaoks. Topeltkirjutamise ühenduses valitud ettevõtetele vastavad andmed sünkroonitakse rakenduste Finance and Operations ja Dataverse vahel. 
 
## <a name="how-to-i-use-the-code-sample"></a>Kui kasutada näidiskoodi?
Näidiskood on C# rakendus, mille saate laadida rakenduses Visual Studio. See võtab NuGeti paketi sõltuvused Dataverse’i SDK-s, mida saate värskendada Visual Studio standardsete tööriistadega. 

Pärast lahenduse lahtipakkimist ja avamist Visual Studios ning NuGeti pakettide taastamist otsige koodist väljendit **TODO**. Iga otsus, mille peate tegema selle kohta, kuidas soovite ettevõtte teavet alglaadida, on tähistatud väljendiga **TODO** ja näidiskoodiga kanoonilise juurutuse jaoks. 

Näidiskood näitab vaid üht mitmest viisist, kuidas olemiridu ettevõtte järgi liigitada. Muutes loogikat väljendiga **TODO** tähistatud jaotistes, saate luua kohandatud liigituse. 

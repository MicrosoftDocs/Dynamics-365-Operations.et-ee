...
---
# <a name="configure-payment-method-settings-that-affect-retail-statements"></a>Jaemüügi väljavõtteid mõjutavate makseviiside sätete konfigureerimine

[!include [task guide banner](../includes/task-guide-banner.md)]

See protseduur selgitab jaekaupluse makseviiside konfiguratsioone, mis mõjutavad jaemüügi väljavõtete loomise ja sisestamise viisi.

Salvestamisel kasutatakse demoettevõtte USRT-i.

1. Avage Jaemüük ja kaubandus > Kanalid > Jaemüügikauplused > Kõik jaemüügikauplused.
2. Otsige loendist ja valige soovitud kirje.
3. Klõpsake loendis valitud real olevat linki.
4. Klõpsake tegumiribal valikut Seadistus.
5. Klõpsake suvandit Makseviisid.
6. Laiendage või ahendage jaotist Sisestamine.
7. Klõpsake nuppu Redigeeri.
    * Valige, kas selle makseviisi puhul saadud summad sisestatakse pearaamatukontole või pangakontole.  
    * Valige konto, millele selle makseviisi puhul saadud summad tuleb sisestada.  

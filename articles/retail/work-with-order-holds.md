...
description: "Selles teemas kirjeldatakse, kuidas töötada tellimuste ootelolekutega rakenduses Microsoft Dynamics 365 for Retail."
author: josaw1
manager: AnnBe
ms.date: 05/14/2018
ms.topic: article
...
# <a name="work-with-call-center-order-holds"></a>Töötamine kõnekeskuse tellimuste ootelolekutega

[!include [banner](includes/banner.md)]

Selles teemas kirjeldatakse tellimuse ooteloleku funktsioone, mida saab rakenduses Microsoft Dynamics 365 for Retail kasutada kõnekeskuse tellimuste jaoks.

...
Kataloogi toodete konfigureerimisel kasutage tegevust **Toote lehe paigutus**, et määratleda konkreetseid lehekülgi, lehekülje protsenti ja kauba üksikasjade paigutust lehel. Nende andmete konfigureerimine võimaldab kasutajatel kasutada **Kataloogiala analüüsi aruannet**. Selle aruande leiate, kui valite **Jaemüük** > **Kõnekeskuse aruanded** > **Kataloogiala analüüsi aruanne**. Selles aruandes analüüsitakse müüke võrdluses kataloogiga (müügitellimused, mille puhul kataloogi lähte-ID oli seotud tellimuse päise või reaga) ning nendega seotud leheküljeprotsenti ja kulusid, et koostada traditsiooniline otseturustamise **Ruuttolli analüüsi** aruanne.

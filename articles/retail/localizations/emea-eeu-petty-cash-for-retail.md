...
Tegumirea **Sisestatud väljavõtete** lehel saate teha järgmist.
  - Väljavõttega seotud sularahamaksete töölehtedele juurdepääsuks avage **Päringud > Sularahamaksete tööleht**.
  - Väljavõttega seotud pearaamatu töölehtedele (v.a kliendimaksed ja sularahamaksed) juurdepääsuks avage **Päringud > Päevaraamat**.
...
- Seadistage **Makseviiside** lehel igale jaemüüja aktsepteeritavale maksetüübile makseviis. Saate Retail POS-i kannete sisestamiseks kasutada erinevaid makseviise. Jaemüügi makseviiside kohta lisateabe saamiseks vt [Makseviise](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/payment-methods).
...
1. Avage **Jaemüük > Haldamise seadistamine > Parameetrid > Jaemüügi parameetrid**. Klõpsake vasakul paanil nuppu **Sisestamine**
...
1. Avage **Jaemüük > Kanalid > Kauplused > Kõik kauplused**.

...
# <a name="analyze-sales-trends-and-patterns"></a><span data-ttu-id="7b007-103">Müügitrendide ja -mustrite analüüsimine</span><span class="sxs-lookup"><span data-stu-id="7b007-103">Analyze sales trends and patterns</span></span>

[!include [banner](includes/banner.md)]

<span data-ttu-id="7b007-104">Saate Microsoft Dynamics 365 for Retailis uurida müügitrende ja -mustreid reaalajas.</span><span class="sxs-lookup"><span data-stu-id="7b007-104">You can study sales trends and patterns in real time in Microsoft Dynamics 365 for Retail.</span></span>

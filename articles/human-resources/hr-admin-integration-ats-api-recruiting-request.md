...
description: See artikkel kirjeldab värbamise taotluse üksust Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
See artikkel kirjeldab värbamise taotluse üksust Dynamics 365 Human Resources.
...
| **Värbamise asukoha ID väärtus**<br>_mshr_fk_recruitingrequestlocation_id_value<br>*GUID* | Kirjutuskaitstud<br>Valikuline<br>Võõrvõti: mshr_hcmrecruitingrequestlocationentityid olemist mshr_hcmrecruitingrequestlocationentity | Süsteemi loodud GUID-väärtus taotlusele valitud asukoha värbamistaotluse tuvastamiseks. |

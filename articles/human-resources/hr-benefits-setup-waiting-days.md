...
1. Tööruumis **Soodustuste haldus** jaotises **Seadistus** valige suvand **Ootepäevad**.
...
3. Määrake järgmiste väljade väärtused.
   ...
   | Väli | Kirjeldus |
   | --- | --- |
   | **Ootepäev** | Ootepäeva kordumatu identifikaator. |
   | **Kirjeldus** | Ootepäeva kirjeldus. |

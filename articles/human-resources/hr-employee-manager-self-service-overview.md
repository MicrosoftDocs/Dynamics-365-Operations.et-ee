...
## <a name="edit-personal-details"></a>Isiklike andmete redigeerimine
...
**Mulle määratud tööüksused** kuvab kõik töövõtjale määratud kinnitused ja töövoo üksused. Saate konfigureerida töövoo üksuseid kasutajale meilisõnumite saatmiseks.

**Mulle määratud küsimustikud** kuvab kõik otse töövõtjale või grupile määratud plaanitud küsimustikud.

**Ettevõtte kataloog** võimaldab töövõtjatel otsivad teavet, mis on seotud üksikisikutega organisatsioonis. Avalik kontaktteave on saadaval kõigile töövõtjatele. Ettevõtte kaust on piiratud ainult ettevõttega, kuhu töövõtja on sisse loginud.

**Meeskonna kalender** kuvab teie meeskonna kalendri teavet. Lisateavet leiate teemast [Meeskonna ja ettevõtte kalendrite kuvamine](hr-employee-self-service-calendar.md).
...
- **Töötaja ümbermääramise taotlus**
- **Töösuhte lõpetamise taotlus**
- **Hüvituse muutmise taotlus**

Saate konfigureerida need suvandid valikulise ülevaatuse ja kinnitamise töövoo läbimiseks.

Suvandi **Ametikoha toimingud** lubamine lubab järgmisi suvandeid.

- **Uue ametikoha taotlus**
- **Ametikoha üksikasjade muutmise taotlemine**

Saate konfigureerida need suvandid ka valikulise ülevaatuse ja kinnitamise töövoo läbimiseks.
...
- **Minu töörühma aeguvad tunnistused**
- **Minu töörühma aeguvad ID-numbrid**
- **Minu töörühma aeguvad katseajad**
- **Minu töörühma aeguvad skriiningud**
- **Minu töörühma aeguvad testid**
- **Avatud ametikohad otsestele ja/või kaudsetele alluvatele**
- **Minu meeskonna ootel olevad vaba aja taotlused**
- **Meeskonnaoskuste hindamine**
- **Oskuste vahe analüüs**
- **Töörühma jõudluse tööraamatud**
- **Meeskonna jõudluse eesmärgid**
- **Meeskonna jõudluse ülevaatused**
- **Lahkuvad töötajad**

Saate konfigureerida järgmisi suvandeid ülemuste jaoks, et nad saaksid muuta või lisada puhkuseavaldusi otseste alluvate eest.

- Serdid
- Kursused
- Laenuartiklid
- Oskused
- Puhkuse ja puudumise taotlused
...
Vahekaart **Kokkuvõte** annab lühiülevaate teie otsestest alluvatest. Kui otsesel alluval on endal alluvaid, kuvatakse kaardi ülaservas otseste alluvate arv ja nupp **Kuva meeskond**. Iga kaardi kohal olevad suvandid rakenduvad valitud töövõtjale. Näiteks kui soovite sisestada puhkusetaotluse töötaja eest, valige töötaja ja seejärel valige **Vaba aja taotlemine** kaartide kohalt. 

Kui valite nupu **Üksikasjad** pärast töötaja valimist, kuvatakse järgmised suvandid.
...
- **Laenatud üksused**
- **Jõudluse eesmärgid**
- **Registreeritud kursused**
- **Oskused**
- **Saada tagasiside**

Sõltuvalt teie organisatsiooni sätetest saate teha muudatusi või ainult vaadata.

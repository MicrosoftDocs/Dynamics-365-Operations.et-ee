...
description: See artikkel kirjeldab, kuidas ametikohad on organisatsiooni hierarhia madalama taseme oluline element.
author: twheeloc
ms.date: 10/28/2021
...
5. Valige **käsk Loo positsioon**.
6. Sisestage **või** valige väärtus väljal Osakond.
7. Sisestage **või** valige väärtus väljal Positsiooni tüüp.
8. Sisestage **või** valige väärtus väljal Tasu piirkond.
...
9. Sisestage **väljale Määratav** saadav kuupäev ja kellaaeg.
10. Laiendage **jaotist Positsiooni** kestus.

    Positsiooni kestus sisestatakse vaikimisi varem sisestatud aktiveerimis- ja pensionilemineku kuupäevade alusel.

11. Laiendage jaotist **Aruanded ametikohale**.
...
12. **Ripploendi** avamiseks klõpsake nuppu Uus.
13. Sisestage **või** valige väärtus väljal Aruanded kuni.
14. Valige **Loo**.
...
19. Sisestage **või valige väärtus** väljal Hierarhia nimi.
20. Sisestage **või valige väärtus** väljal Positsiooniaruanded.
21. Laiendage **jaotist** Palk.
22. Sisestage **või valige** väärtus väljal Maksetsükkel.
23. Sisestage **või valige väärtus** väljal Makstud.
24. Sisestage **väljale Iga-aastased** regulaarsed tunnid arv.
...
25. Laiendage **jaotist Tööjõu** liit.
26. Ahendab **ametiühingu** jaotise.
27. Laiendage jaotist **Finantsdimensioonid**.
28. Sisestage **või** valige väärtus väljal Jaotusmall.
29. Sisestage **või** valige väärtus väljal Osakond.

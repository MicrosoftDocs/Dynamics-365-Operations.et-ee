...
---
# <a name="configure-life-event-types"></a>Elusündmuste tüüpide konfigureerimine
...
| Kindlustuskaitse muutus (palk) | Töötaja > Kompensatsioon > Põhipalk | Kompensatsiooni muutmisel arvutatakse aastane soodustuse palk automaatselt ümber |

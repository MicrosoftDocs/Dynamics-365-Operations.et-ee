...
3. Määrake järgmiste väljade väärtused.
   ...
   | Maksesageduse määra arvutamine | Maksesageduse määra arvutamise meetod: tavaline või aastane. |
   ...
   | Jõustumiskuupäeva muutmine | Soodustuse määra muudatuse jõustumise kuupäev. Süsteem muudab automaatselt soodustuste määra ja uuendab kõiki selle määraga seotud soodustuse plaane, kui käitate määra muutmise uuendamise töötluse. Te ei tohiks seda kuupäeva seada, kui te ei soovi, et süsteem uuendaks selle määra põhjal töövõtja soodustuse plaane automaatselt. See on tavaliselt reserveeritud automaatsele tulevase määra muutmise töötlusele. Muudatuse jõustumiskuupäev peab jääma soodustuse määra ja aegumiskuupäeva piiresse. |

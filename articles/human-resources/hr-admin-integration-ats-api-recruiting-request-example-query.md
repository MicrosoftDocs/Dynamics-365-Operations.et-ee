...
description: See artikkel annab näidispäringu üksuse Värbamisnõude üksuse kohta üksuses Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858210"
---
# <a name="example-query-for-recruiting-request"></a>Värbamistaotluse näidispäring
...
See artikkel annab näidispäringu üksuse Värbamisnõude üksuse kohta üksuses Dynamics 365 Human Resources.

Järgmine päring näitab, kuidas saate kasutada päringu suvandit $expand GET-toimingus, et tuua konkreetse taotluse jaoks välja määratletud värbamistaotluse kirje ja kõik seotud ametikohad, vajalikud oskused ning haridusnõuded. Näite vastus näitab värbamistaotlus kahele ametikohale ja taotletud ametikohtade jaoks nõutavad oskused ja hariduse.

---
title: Värbamistaotluse näidispäring
description: See teema annab näidispäringu Värbamisnõude olemi kohta rakenduses Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "6057402"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="e88d8-103">Värbamistaotluse näidispäring</span><span class="sxs-lookup"><span data-stu-id="e88d8-103">Example query for Recruiting request</span></span>

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

<span data-ttu-id="e88d8-104">See teema annab näidispäringu Värbamisnõude olemi kohta rakenduses Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="e88d8-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="e88d8-105">Järgmine päring näitab, kuidas saate kasutada päringu suvandit $expand GET-toimingus, et tuua konkreetse taotluse jaoks välja määratletud värbamistaotluse kirje ja kõik seotud ametikohad, vajalikud oskused ning haridusnõuded.</span><span class="sxs-lookup"><span data-stu-id="e88d8-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="e88d8-106">Näite vastus näitab värbamistaotlus kahele ametikohale ja taotletud ametikohtade jaoks nõutavad oskused ja hariduse.</span><span class="sxs-lookup"><span data-stu-id="e88d8-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="e88d8-107">**Taotlus**</span><span class="sxs-lookup"><span data-stu-id="e88d8-107">**Request**</span></span>
...
<span data-ttu-id="e88d8-108">**Vastus**</span><span class="sxs-lookup"><span data-stu-id="e88d8-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="e88d8-109">Vt ka</span><span class="sxs-lookup"><span data-stu-id="e88d8-109">See also</span></span>

[<span data-ttu-id="e88d8-110">Kandidaadi jälgimissüsteemi integreerimise API tutvustus</span><span class="sxs-lookup"><span data-stu-id="e88d8-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>

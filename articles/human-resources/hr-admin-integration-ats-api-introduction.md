...
description: See artikkel kirjeldab kandidaadi Dynamics 365 Human Resources jälgimissüsteemi (ATS) integratsiooni API-d.
...
See artikkel kirjeldab kandidaadi Dynamics 365 Human Resources jälgimissüsteemi (ATS) integratsiooni API-d. API eesmärk on võimaldada sujuvat integreerimist rakenduse Dynamics 365 Human Resources ja partneriks olevate ATS-ide vahel.

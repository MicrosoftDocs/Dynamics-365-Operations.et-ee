...
## <a name="adjust-leave-balances"></a>Puhkusesaldode korrigeerimine

1. Töövõtja kirjes valige suvand **Puhkus**.

2. Valige suvand **Puhkuste ja puudumiste seadistamine**.

3. Valige **Saldo korrigeerimine**.

4. Valige **Puhkuse tüüp**.

5. Sisestage **Korrigeeritud summa**. 

6. Lisaks saate soovi korral valida suvandi **Kuupäev**. 

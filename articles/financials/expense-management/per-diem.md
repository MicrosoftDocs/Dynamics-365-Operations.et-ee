...
<span data-ttu-id="a051c-109">Päevaraha kogusumma arvutus põhineb algus- ja lõppkuupäevadel, mille saate seada lehel **Päevarahad**.</span><span class="sxs-lookup"><span data-stu-id="a051c-109">The calculation of a total per diem amount is based on the start dates and end dates that you can set on the **Per diems** page.</span></span>

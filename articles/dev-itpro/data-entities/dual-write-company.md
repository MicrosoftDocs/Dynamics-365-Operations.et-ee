...
Rakenduses Microsoft Dynamics 365 for Finance and Operations on mõiste *ettevõte* nii juriidiline kui ka ka ärikonstruktsioon. See on ka andmete turvalisuse ja nähtavuse piir. Kasutajad töötavad alati ühe ettevõtte kontekstis ning ettevõte segmendib enamiku andmetest.

Teenuses Common Data Service pole ei ole samaväärset mõistet. Lähim mõiste on *äriüksus*, mis on peamiselt kasutajaandmete turvalisuse ja nähtavuse piir. Sellel mõistel pole sama juriidilist ega ärimõju nagu ettevõtte mõistel rakenduses Finance and Operations.

Kuna äriüksus ja ettevõte ei ole samaväärsed mõisted, ei ole võimalik jõustada üks-ühele (1:1) vastendust nende vahel teenuse Common Data Service integratsiooni eesmärgil. Kuid kuna kasutajad peavad vaikimisi nägema samu kirjeid rakenduses Finance and Operationsis ja teenuses Common Data Service, on Microsoft kasutusele võtnud uue olemi teenuses Common Data Service nimega CDM\_Company. See olem on samaväärne rakenduse Finance and Operations olemiga Ettevõte. Selleks, et kirjete nähtavus oleks valmislahendusena rakenduse Finance and Operations ja teenuse Common Data Service vahel samaväärne, soovitame teenuse Common Data Service andmete järgmist seadistust.
...
+ Mistahes kirje omanik, mis on loodud rakenduses Finance and Operations ja kahesuguselt kirjutatud teenusesse Common Data Service, on vaikimisi määratud väärtuseks „DW omanikust töörühm, mis on lingitud seostatud äriüksusega.
...
Selle konfiguratsiooni tõttu kuulub kõigi USMF-i ettevõttega seotud Finance and Operationsi kirje töörühmale, mis on seotud USMF-i äriüksusega teenuses Common Data Service. Seetõttu saab iga kasutaja, kellel on juurdepääs sellele äriüksusele turberolli kaudu, mis on määratud äriüksuse tasemel nähtavusele, nüüd näha neid kirjeid. Järgnev näide näitab, kuidas töörühmi saab kasutada neile kirjetele õige juurdepääsu pakkumiseks.
...
+ Ainult kirjed, millel on ettevõtte andmed on kahesuguse kirjutamise õigused rakenduse Finance and Operations ja teenuse Common Data Service vahel.

...
> [!NOTE]
> Simple Mail Transfer Protocoli (SMTP) server peab olema konfigureeritud ja saadaval. Saate määrata oma SMTP-serveri Finance and Operationsi jaotises **Süsteemihaldus** &gt; **Seadistus** &gt; **Meil** &gt; **Meiliparameetrid**.
...
> [!NOTE]
> Tööarhiivi jaoks saate dokumenditüübi valida Finance and Operationsi jaotises **Organisatsiooni haldus** &gt; **Tööruumid** &gt; **Elektrooniline aruandlus** &gt; **Elektroonilise aruandluse parameetrid**.

...
Peate juurutama rakenduse Microsoft Dynamics 365 for Finance and Operations topoloogia, mis toetab pidevat järku. (Lisateavet vt jaotisest [Pideva järgu ja testimise automaatikat toetavate topoloogiate juurutamine](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/perf-test/continuous-build-test-automation).) Teil peab rakenduse Finance and Operations topoloogiale olema juurdepääs ühe järgmise rolli jaoks:

- Elektroonilise aruandluse arendaja
- Elektroonilise aruandluse funktsionaalne konsultant
- Süsteemiadministraator

Samuti peab teil selle Finance and Operationsi topoloogia puhul olema juurdepääs arenduskeskkonnale.
...
Dokumentide loomiseks, mille jaoks plaanite lisada kohandatud talletuskoha, looge praeguses rakenduse Finance and Operations topoloogias [uus elektroonilise aruandluse vorming](tasks/er-format-configuration-2016-11.md). Teise võimalusena [importige olemasolev elektroonilise aruandluse vorming sellesse topoloogiasse](general-electronic-reporting-manage-configuration-lifecycle.md).

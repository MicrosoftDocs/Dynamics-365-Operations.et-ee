...
-   Veeru definitsiooni päiste ala sisaldab aruandes kuvatavat päiseteksti ja vormingut. Päis saab rakenduda üksikule andmeveerule, laieneda üle mitme veeru või rakenduda veergudele tingimuslikkuse alusel. Veeru määratlus võib sisaldada nii palju veerupäise ridasid, kui vajate. **Märkus.** Veerupäised rakenduvad aruande igale andmeveerule. Aruande päised rakenduvad kogu aruandele. Saate määratleda aruande päiseid aruande definitsiooni vahekaardil **Päised ja jalused**.
...
Aruandekoostur saab veerupäiseid automaatteksti koodide alusel automaatselt luua. Automaatteksti koodid on muutujad, mida värskendatakse iga kord, kui aruanne luuakse. Veerupäis võib sisaldada neid koode varieeruva aruandeteabe, nagu kuupäevade või perioodinumbrite määramiseks. Seetõttu saate kasutada ühte veeru definitsiooni mitme aruande definitsiooni, ajaperioodi ja aruandluspuu puhul. Kuna automaatteksti koodid olenevad veeru määratluse üksikasjade ridade kalendriteabest, toetatakse neid ainult veergude <strong>CALC</strong>, <strong>FD</strong> ja <strong>WKS</strong> puhul. Automaatteksti koodi veerupäise lahtris kuvamise viis mõjutab selle teabe ilmet aruandes. Automaatteksti koodid kuvatakse dialoogiboksis <strong>Veeru päis</strong> erineva tõstuga. Seega kuvatakse tekst aruandes erinevate tõstudega. Näiteks standardses kalendriaastas teisendab <strong>@CalMonthLong</strong> kuu <strong>7</strong> valikule <strong>Juuli</strong>. Kui kuu nimi peaks olema suurtäheline (nt <strong>JUULI</strong>), sisestage automaatteksti kood suurtähtedega väljale <strong>Veerupäise tekst</strong>. Näiteks sisestage <strong>@CALMONTHLONG</strong>. Võite koode ja teksti kombineerida. Näiteks saate sisestada järgmise päiseteksti: <strong>Periood @FiscalPeriod-@FiscalYear alates @StartDate kuni @EndDate</strong>. Loodav aruande pealkiri sarnaneb järgmisega: <strong>Periood 1-02 alates 01/01/02 kuni 01/31/02</strong>. <strong>Märkus.</strong> Osa teksti, nt pika kuupäeva, vorming oleneb teie regioonisätetest Finance and Operationsi serveris. Nende sätete muutmiseks klõpsake nuppu <strong>Start</strong>, klõpsake suvandit <strong>Juhtpaneel</strong> ja seejärel klõpsake suvandit <strong>Regioon ja keel</strong>. Järgmises tabelis loetletakse veerupäiste puhul saadaolevad automaatteksti suvandid.
...
|------------------------------|------|----------------------|
| Veeru tüüp                  | DESC | FD                   |
| Arvestuskood/atribuudikategooria |      | ACTUAL               |
| Finantsaasta                  |      | BASE                 |
| Periood                       |      | 1:BASE               |
...
|----------------------------------------------|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|         Füüsiline/pärinev valuuta         | <strong>Jeen</strong> |                                                                   <strong>Y6000</strong> – tulemuseks kuvatakse ainult jeenides sisestatud kanded.                                                                   |
| Ettevõtte teabe ametlik valuuta | <strong>Jeen</strong> |          <strong>$60</strong> – tulemuseks kuvatakse ainult Jaapani jeenides sisestatud kanded USA dollarites. <strong>Märkus.</strong> Valuutakurss on ligikaudu 100 Jaapani jeeni USA dollari kohta.           |
| Funktsionaalne valuuta ettevõtte andmetest |        Tühi         | <strong>$2310\*\</strong>* – tulemus kuvab kõik andmed ettevõtte andmetes määratud ametlikus valuutas. <strong>Märkus.</strong> See summa on kõigi kannete summa funktsionaalses valuutas. |
|         Füüsiline/pärinev valuuta         |        Tühi         |                                                       <strong>$2250</strong> – tulemuseks kuvatakse kõik summad kande tegemise valuutas.                                                        |

### <a name="calculation-column-in-a-column-definition"></a>Veeru definitsiooni arvutuse veerg

Veeru määratluses olev **CALC**‑tüüpi veerg toetab keerukaid arvutusi lahtris <strong>Valem</strong> ning võib sisaldada tehtemärke <strong>+</strong>, <strong>-</strong>, <strong>\</strong> ja **/*, samuti lauseid <strong>IF/THEN/ELSE</strong>. Arvutuse veerg võib viidata ka mis tahes muule veerule, sh järgnevatele veergudele. Lisaks võib arvutuse veerg veeru päiste toetamiseks sisaldada ka rahandusaastat ja perioodi. Arvutusvalem võib olla kuni 1024 märki pikk. Arvutustulemuse väljendamiseks protsendina kasutage kindla vormingu alistamist. <strong>Märkus.</strong> Arvutusvalemite tulemused ei sisalda mitteprinditavate veergude vahemikes olevaid väärtusi. Näiteks valemi <strong>A:D</strong> korral prinditakse tulemuseks <strong>0</strong> (null), samas kui valemi <strong>A+B+C</strong> korral arvutatakse mitteprinditavate väärtuste väärtus.

...
ms.locfileid: "362943"
---
# <a name="create-formats-to-use-document-management-files-in-er-output"></a>Vormingute loomine dokumendihalduse failide kasutamiseks elektroonilise aruandluse väljundis

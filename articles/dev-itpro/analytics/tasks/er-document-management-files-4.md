...
---
# <a name="run-format-to-use-document-management-files-in-format-outputs"></a>Vormingu käivitamine dokumendihalduse failide vormingu väljundites kasutamiseks 

...
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>LinkedIni ja rakenduse Attract integreerimise tõrkeotsing
...
## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Te ei saa Attractist LinkedIni sisse logida

Kui teil on probleeme Attractist LinkedIni sisselogimisega, proovige järgmist.

1. Kontrollige, kas Attracti sisestatud LinkedIni mandaadid on kehtivad ja õiged.
2. Kui mandaadid on kehtivad ja õiged, võtke ühendust [LinkedIni toega](https://www.linkedin.com/help/linkedin).
3. Kui probleem ei lahene, võtke ühendust [Microsofti toega](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Tööpakkumisi Attractist ei kuvata LinkedInis

...
| Ülesanne | Lisateave |
|------|------------------|
| Küsige kogukonnalt. | Küsimustele abi saamiseks minge [Dynamics 365 Talent kogukond](https://community.dynamics.com/365/talent). Vastuste leidmiseks sisestage küsimus otsinguväljale lause **Mul on küsimus** kõrval. Küsimuse esitamiseks valige **Küsimuse küsimine**. |

...
---
# <a name="enable-broadbean-integration"></a>Luba Broadbeani integreerimine
...
3. Looge Broadbeaniga ühendus ja sisestage oma andmed väljadele **Kasutajanimi**, **Kliendi ID** ja **Krüptimise luba**.

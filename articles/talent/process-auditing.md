...
Saa vaadata jälgitud andmeid rakendusega Power BI, kasutades OData konnektorit. Lisateavet vt jaotisest [OData-kanalitega ühendamine Power BI Desktop](https://docs.microsoft.com/en-us/power-bi/desktop-connect-odata).

## <a name="track-changes"></a>Jälita muutusi
Muudatuste jälgimiseks värbamisandmetes toimige järgmiselt.

1. Valige [PowerApps](https://web.powerapps.com)sobiv keskkond.

...
---
# <a name="create-a-hiring-process-template-in-attract"></a>Värbamisprotsessi malli loomine Attractis

[!include [banner](includes/banner.md)]

*Värbamisprotsessi mall* sisaldab kõiki tegevusi, mis peaksid olema tööle värbamise protsessi osad. Selles teemas kirjeldatakse protsessimalli rakenduses Microsoft Dynamics 365 Talent: Attract. Lisaks selgitatakse, kuidas malli luua.
...
Tegevuste kohta lisateabe saamiseks vt [Tegevused värbamisprotsessides](./activities-attract.md).

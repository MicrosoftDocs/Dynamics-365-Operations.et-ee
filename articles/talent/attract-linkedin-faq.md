...
description: See teema vastab küsimustele, mis võivad olla seotud LinkedIni ja Microsoft Dynamics 365 for Talent - Attracti integreerimisega.
author: hasrivas
manager: AnnBe
ms.date: 07/08/2019
ms.topic: article
...
ms.locfileid: "1756195"
---
# <a name="linkedin-integration-faq"></a>LinkedIni integreerimise KKK

[!include [banner](includes/banner.md)]

LinkedIn on maailma suurim tööalane veebivõrgustik. Microsoft Dynamics for Talent: Attract integreerub LinkedIniga, et anda juurdepääs maailma tipptalentidele. Attract võimaldab postitada tööpakkumised otse LinkedIni ja samuti kandidaatide teavet LinkedInist Attracti tõmmata.

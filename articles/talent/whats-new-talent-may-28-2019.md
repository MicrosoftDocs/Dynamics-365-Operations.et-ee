...
ms.locfileid: "1616472"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-may-28-2019"></a>Mis on uut või mida on muudetud rakenduses Dynamics 365 for Talent (28. mai 2019)
...
Jaotises kirjeldatud muudatused rakenduvad järgunumbrile 8.1.2319.

### <a name="common-data-service-entity-support-for-custom-fields"></a>Common Data Service'i üksuse tugi kohandatud väljadele

Selles väljaandes toetavad nüüd järgmised teenuse Common Data Service üksused kohandatud välju: soodustuse arvutamise määra üksikasjad, töökalendri pühade rida ja tööhõive.

### <a name="copy-position-now-includes-payroll-details"></a>Ametikoha kopeerimise funktsioon sisaldab nüüd palga üksikasju
Kui kasutate käsku **Kopeeri ametikoht** ja valite kõik suvandid, kaasatakse nüüd kopeeritavasse teabesse ka palgaarvestuse üksikasjad. 
...
Organisatsioonid võivad töötajatele pakkuda mitut erinevat tüüpi puhkust. Mõned puhkusetüübid ei pruugi olla töötajatele sobivad puhkuse taotluse esitamiseks ja neid haldab selle asemel personaliosakond. Selle väljalaskega saate konfigureerida, milliseid puhkusetüüpe töötajad esitada saavad. 

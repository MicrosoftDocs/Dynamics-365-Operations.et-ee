...
#### [Platvormivärskendus 15 (märts 2018)](get-started/whats-new-platform-update-15.md)
#### [Väljaanded ja elutsükli poliitika](../dev-itpro/migration-upgrade/versions-update-policy.md?toc=/fin-and-ops/toc.json)
...
#### [Elektroonilise aruandluse vormingu muutmine Microsoft Exceli malli uuesti rakendades](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md?toc=/fin-and-ops/toc.json)
...
##### [Elektroonilise aruandluse andmemudeli loomine finantsdimensioonide kasutamiseks andmeallikana](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse mudelite vastendamine finantsdimensioonide kasutamiseks andmeallikana](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse aruande koostamine finantsdimensioonide kasutamiseks andmeallikana](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse finantsdimensioone kasutava aruande käitamine andmeallikana](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse loendamis- ja liitmisvormingu loomine](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse arvutuste konfigureerimine loendamiseks ja liitmiseks](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse arvutuste konfigureerimine loendamise ja liitmise väljundi loomiseks](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu käitamine loendamiseks ja liitmiseks](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu loomine, et kasutada horisontaalselt laiendatavaid vahemikke Exceli aruannete veergude dünaamiliseks lisamiseks](../dev-itpro/analytics/tasks/er-horizontal-1.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu, mis kasutab horisontaalselt laiendatavaid vahemikke Exceli aruannete veergude dünaamiliseks lisamiseks, käitamine](../dev-itpro/analytics/tasks/er-horizontal-2.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse andmemudeli ettevalmistamine dokumendihalduse failide kasutamiseks vormingu väljundites](../dev-itpro/analytics/tasks/er-document-management-files-1.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse andmemudeli laiendamine dokumendihalduse failide kasutamiseks vormingu väljundites](../dev-itpro/analytics/tasks/er-document-management-files-2.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu loomine dokumendihalduse failide kasutamiseks vormingu väljundites](../dev-itpro/analytics/tasks/er-document-management-files-3.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu käitamine dokumendihalduse failide kasutamiseks vormingu väljundites](../dev-itpro/analytics/tasks/er-document-management-files-4.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu muutmine ja käitamine dokumendihalduse failide kasutamiseks vormingu väljundites](../dev-itpro/analytics/tasks/er-document-management-files-5.md?toc=/fin-and-ops/toc.json)
##### [Konfiguratsioonide kujundus elektroonilise aruandluse aruannete loomiseks manustatud piltidega Microsoft Office’i vormingus (ER) (osa 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Konfiguratsioonide läbivaatus elektroonilise aruandluse aruannete koostamiseks manustatud piltidega Microsoft Office’i vormingus](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse aruannete loomine manustatud piltidega Microsoft Office’i vormingus](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md?toc=/fin-and-ops/toc.json)
...
##### [Elektroonilise aruandluse konfiguratsioonide importimine avalduse andmete uuendamisega dokumentide genereerimiseks](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse avalduse andmete uuendamisega dokumentide genereerimiseks](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse mudeli muutmine ja vastendamine avalduse andmete uuendamisega dokumentide genereerimiseks](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse vormingu muutmine avalduse andmete uuendamisega dokumentide genereerimiseks](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md?toc=/fin-and-ops/toc.json)
##### [Elektroonilise aruandluse avalduse andmete uuendamisega dokumentide genereerimiseks](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md?toc=/fin-and-ops/toc.json)
...
#### [Elektroonilise aruandluse konfiguratsiooni üleslaadimine teenusesse Lifecycle Services](../dev-itpro/analytics/tasks/er-upload-configuration-into-lifecycle-services.md?toc=/fin-and-ops/toc.json)

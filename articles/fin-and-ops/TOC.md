...
#### [Kuluobjekti saldo kuvamine (tegevuse juhis)](../supply-chain/cost-management/tasks/view-cost-object-balance.md)
#### [Varude aruande ja KPI kuvamine kuluobjekti järgi (tegevuse juhis)](../supply-chain/cost-management/tasks/view-inventory-statement-kpi-cost-object.md)
#### [Kulukirje](../supply-chain/cost-management/cost-entries.md)
#### [Kuluobjekti kulukirjete kuvamine (tegevuse juhis)](../supply-chain/cost-management/tasks/view-cost-entries-cost-object.md)
...
#### [Tootmistellimuse WIP praeguse oleku kuvamine (tegevuse juhis)](../supply-chain/cost-management/tasks/view-current-wip-status-production-order.md)
#### [Tootmistellimuse aktiivsete, hinnanguliste ja realiseeritud kulude võrdlemine (tegevuse juhis)](../supply-chain/cost-management/tasks/compare-active-estimated-realized-costs.md)
...
#### Koosluse arvutused kuluarvutustabeli abil (järjestikused ülesande juhised tehnilise ülevaate jaoks)
##### [Valmistoote loomine (ainult veebruar 2016)](../supply-chain/cost-management/tasks/create-finished-product-2016-02.md)
##### [Pooltoote loomine (ainult veebruar 2016)](../supply-chain/cost-management/tasks/create-semi-finished-product-2016-02.md)
##### [Toormaterjalide loomine (ainult veebruar 2016)](../supply-chain/cost-management/tasks/create-raw-materials-2016-02.md)
##### [Koosluste loomine (ainult veebruar 2016)](../supply-chain/cost-management/tasks/create-boms-2016-02.md)
##### [Protsesside loomine (ainult veebruar 2016)](../supply-chain/cost-management/tasks/create-routes-2016-02.md)
...
## [Andmehaldus](../dev-itpro/data-entities/data-entities-data-packages.md)
...
#### [Kulujuhtimisüksuste määramine (tegevuse juhis)](../financials/cost-accounting/tasks/define-cost-control-units.md)
#### [Kuluarvestuse pearaamatu loomine (tegevuse juhis)](../financials/cost-accounting/tasks/create-cost-accounting-ledger.md)
#### [Statistilise dimensiooni liikmed ja statistiliste mõõtude pakkuja mallid](../financials/cost-accounting/statistical-measure-provider-template.md)
#### [Eraldamisaluse määramine](../financials/cost-accounting/allocation-bases.md)
...
#### [Rakenduste komplekti aruande andmekomplektide laiendamine](../dev-itpro/analytics/expand-app-suite-report-data-sets.md)
...
### [Inventuuriprotsesside määramine (tegevuse juhis)](../supply-chain/inventory/tasks/define-inventory-counting-processes.md)
...
## [Tootmine](../supply-chain/production-control/production-process-overview.md)
...
##### [Tootmise sisestamine](../supply-chain/cost-management/production-posting.md)
#### Diskreetse tootmise ülesanded
##### [Diskreetse tootmise ressursigrupi määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-discrete-manufacturing-resource-group.md)
##### [Tootmisvoo versioonile olemasoleva tegevuse lisamine (tegevuse juhis)](../supply-chain/production-control/tasks/add-existing-activity-production-flow-version.md)
##### [Tootmisvoo versiooni inaktiveerimine (tegevuse juhis)](../supply-chain/production-control/tasks/deactivate-production-flow-version.md)
##### [Tootmisvoo versiooni aegumiskuupäeva määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-expiry-date-production-flow-version.md)
##### [Tootmisvoo mudelite määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-production-flow-models.md)
##### [Tööaegade plaanimisatribuutide loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-working-time-scheduling-properties.md)
##### [Tööaja mallide loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-working-time-templates.md)
##### Tootmistellimuse töötsükli haldamine
###### [Tootmistellimuse loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-production-order.md)
###### [Tootmistellimuse hindamine (tegevuse juhis)](../supply-chain/production-control/tasks/estimate-production-order.md)
###### [Tootmistellimuse plaanimine (tegevuse juhis)](../supply-chain/production-control/tasks/schedule-production-order.md)
###### [Tootmistellimuse vabastamine (tegevuse juhis)](../supply-chain/production-control/tasks/release-production-order.md)
###### [Tootmistellimuse alustamine (tegevuse juhis)](../supply-chain/production-control/tasks/start-production-order.md)
###### [Tootmistellimuse lõpuleviimisest teatamine (tegevuse juhis)](../supply-chain/production-control/tasks/report-production-order-finished.md)
###### [Tootmistellimuse lõpetamine (tegevuse juhis)](../supply-chain/production-control/tasks/end-production-order.md)
###### [Tootmistellimuse plaanimine koos toimingute ja tööde plaanimisega (tegevuse juhis)](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
##### [Operatsiooniressursi loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-operations-resource.md)
##### [Ressursivõimaluste määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-resource-capabilities.md)
##### [Tööajaarvestuse palgaarvestuse protsessi lubamine (tegevuse juhis)](../supply-chain/production-control/tasks/payroll-process-time-attendance.md)
##### [Lõpetatuna kinnitamine registreerimismärgipõhises asukohas (tegevuse juhis)](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
##### [Edenemisteabe esitamine töö mobiilses seadmes (tegevuse juhis)](../supply-chain/production-control/tasks/report-progress-mobile-job-device.md)
##### [Puhvervaru abil minimaalse laovaru uuendamine (tegevuse juhis)](../supply-chain/production-control/tasks/use-safety-stock-journal-update-minimum-coverage.md)
##### [Töötaja konfigureerimine töö mobiilse seadme abil (tegevuse juhis)](../supply-chain/production-control/tasks/worker-mobile-job-device.md)
...
##### [Tootmise tagasiside](../supply-chain/production-control/production-feedback.md)
#### Lean manufacturingi ülesanded
##### [Lean manufacturingi töörakkude määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-lean-manufacturing-work-cells.md)
##### [Säästliku graafiku gruppide määramine (tegevuse juhis)](../supply-chain/production-control/tasks/define-lean-schedule-groups.md)
##### Tootmisvood ja tegevused – lean manufacturing 
###### [Tootmisvoo versiooni loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-production-flow-version.md)
###### [Protsessitegevuste loomine: lean manufacturing (tegevuse juhis)](../supply-chain/production-control/tasks/create-process-activities-lean-manufacturing.md)
###### [Ülekandetegevuste loomine: lean manufacturing (tegevuse juhis)](../supply-chain/production-control/tasks/create-transfer-activities-lean-manufacturing.md)
###### [Tootmisvoo ja versiooni kinnitamine (tegevuse juhis)](../supply-chain/production-control/tasks/validate-production-flow-version.md)
###### [Tootmisvoo versiooni aktiveerimine (tegevuse juhis)](../supply-chain/production-control/tasks/activate-production-flow-version.md)
###### [Tegevuse seose loomine: järgnev tegevus (tegevuse juhis)](../supply-chain/production-control/tasks/create-activity-relation-successor.md)
###### [Tootmisvoo tegevusele eelkäija lisamine (tegevuse juhis)](../supply-chain/production-control/tasks/add-predecessor-production-flow-activity.md)
###### [Väärtusvoo loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-value-stream.md)
##### [Säästlik sidumine müügitellimuste põhjal (tegevuse juhis)](../supply-chain/production-control/tasks/lean-pegging-sales-orders.md)
##### [Alltöövõtu tööraku loomine – lean manufacturing (tegevuse juhis)](../supply-chain/production-control/tasks/create-subcontracted-work-cell-lean-manufacturing.md)
##### [Kanban-koguse arvutuspoliitika lisamine kanban-reeglile (tegevuse juhis)](../supply-chain/production-control/tasks/add-kanban-quantity-calculation-policy-kanban-rule.md)
##### [Kanban-koguse soovituste arvutamine (tegevuse juhis)](../supply-chain/production-control/tasks/calculate-kanban-quantity-suggestions.md)
##### [Kanban-reeglite muutmine protsessitöö jaoks (tegevuse juhis)](../supply-chain/production-control/tasks/change-kanban-rules-process-job.md)
##### [Koosluserea sündmuse kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-bom-line-event-kanban-rule.md)
##### [Fikseeritud kogusega kanban-reegli loomine tootmise jaoks (tegevuse juhis)](../supply-chain/production-control/tasks/create-fixed-quantity-kanban-rule-manufacturing.md)
##### [Kanban-rea sündmuse abil kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-kanban-rule-kanban-line-event.md)
##### [Minimaalsete laovarude sündmuse abil kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-kanban-rule-minimum-stock-event.md)
##### [Mitme tegevuse kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-kanban-rule-multiple-activities.md)
##### [Uue kanban-reegli loomine olemasoleva kanban-reegli dubleerimise teel (tegevuse juhis)](../supply-chain/production-control/tasks/create-new-kanban-rule-duplicating-existing-kanban-rule.md)
##### [Asenduskanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-replacement-kanban-rule.md)
##### [Müügisündmuse kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-sales-event-kanban-rule.md)
##### [Väljastamise kanban-reegli loomine (tegevuse juhis)](../supply-chain/production-control/tasks/create-withdrawal-kanban-rule.md)
##### [Kanbani protsessitööde käivitamine (tegevuse juhis)](../supply-chain/production-control/tasks/execute-kanban-process-jobs.md)
##### [Ajastatud kanban-tööde teisaldamine (tegevuse juhis)](../supply-chain/production-control/tasks/move-scheduled-kanban-jobs.md)
##### [Protsessi kanban-töö ettevalmistamine, kui materjalid on tööraku jaoks saadaval (tegevuse juhis)](../supply-chain/production-control/tasks/prepare-kanban-job-materials.md)
##### [Protsessi kanban-töö ettevalmistamine, kui materjalid pole tööraku jaoks saadaval (tegevuse juhis)](../supply-chain/production-control/tasks/prepare-process-kanban-job-materials-not-available.md)
##### [Kanban-töö eemaldamine graafikust (tegevuse juhis)](../supply-chain/production-control/tasks/remove-kanban-job-schedule.md)
##### [Kanban-töö oleku taastamine (tegevuse juhis)](../supply-chain/production-control/tasks/revert-kanban-job-status.md)
##### [Kanban-tööde ajastamine (tegevuse juhis)](../supply-chain/production-control/tasks/schedule-kanban-jobs.md)
##### [Kanban-töödega materjalide ülekandmine (tegevuse juhis)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
##### [Kanbani oleku värskendamine (tegevuse juhis)](../supply-chain/production-control/tasks/update-kanban-status.md)
...
##### [Valemi loomine, kopeerides olemasolevast valemist (tegevuse juhis)](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Partii tellimuse elutsükkel loomisest käivitamiseni (tegevuse juhis)](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Tootmistööde järjestamine tootmisprotsessiks (tegevuse juhis)](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)




## [Tooteteabe haldus](../supply-chain/pim/product-information.md)
### [Tooteteave](../supply-chain/pim/product-information.md)
...
#### [Koosluse kalkulatsioonid](../supply-chain/cost-management/bom-calculations.md)
### [Toote konfiguratsioonimudelid](../supply-chain/pim/build-product-configuration-model.md)

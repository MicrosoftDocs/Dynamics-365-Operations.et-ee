...
5. Otsige loendist ja valige soovitud kirje.
    * Valige organisatsiooni hierarhiale määratav eesmärk.  
6. Klõpsake vahekaarti Lisa.
7. Märkige loendis valitud rida.
    * Otsige äsja loodud hierarhia üles.  
8. Klõpsake nuppu OK.
...
1. Otsige loendist ja valige soovitud kirje.
    * Valige hierarhia.  
2. Klõpsake käsku Kuva hierarhia.
    * Vajaduse korral lisage organisatsioone.  
    * Organisatsiooni lisamiseks klõpsake nuppu Redigeeri ja seejärel organisatsiooni lisamiseks nuppu Sisesta.     Kui olete muudatuste tegemise lõpetanud, saate salvestada mustandi ja/või muudatused avaldada.  

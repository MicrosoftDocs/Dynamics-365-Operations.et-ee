...
# <a name="workflow-system"></a><span data-ttu-id="27ed6-103">Töövoo süsteem</span><span class="sxs-lookup"><span data-stu-id="27ed6-103">Workflow system</span></span>
...
+ [<span data-ttu-id="27ed6-128">Töövoo arhitektuur</span><span class="sxs-lookup"><span data-stu-id="27ed6-128">Workflow architecture</span></span>](workflow-system-architecture.md)
+ [<span data-ttu-id="27ed6-129">Töövoo elemendid</span><span class="sxs-lookup"><span data-stu-id="27ed6-129">Workflow elements</span></span>](workflow-elements.md)
+ [<span data-ttu-id="27ed6-130">Töövoo tegevused</span><span class="sxs-lookup"><span data-stu-id="27ed6-130">Workflow actions</span></span>](workflow-actions.md)
+ [<span data-ttu-id="27ed6-131">Töövoo loomine</span><span class="sxs-lookup"><span data-stu-id="27ed6-131">Create a workflow</span></span>](create-workflow.md)
+ [<span data-ttu-id="27ed6-132">Töövoo atribuutide konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-132">Configure workflow properties</span></span>](configure-workflow-properties.md)
+ [<span data-ttu-id="27ed6-133">Töövoos käsitsi ülesande konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-133">Configure a manual task in a workflow</span></span>](configure-manual-task-workflow.md)
+ [<span data-ttu-id="27ed6-134">Töövoos automaatse ülesande konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-134">Configure an automated task in a workflow</span></span>](configure-automated-task-workflow.md)
+ [<span data-ttu-id="27ed6-135">Töövoo kinnitusprotsessi konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-135">Configure an approval process in a workflow</span></span>](configure-approval-process-workflow.md)
+ [<span data-ttu-id="27ed6-136">Töövoo kinnitusetapi konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-136">Configure an approval step in a workflow</span></span>](configure-approval-step-workflow.md)
+ [<span data-ttu-id="27ed6-137">Töövoos käsitsi otsuse konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-137">Configure a manual decision in a workflow</span></span>](configure-manual-decision-workflow.md)
+ [<span data-ttu-id="27ed6-138">Töövoos tingimusliku otsuse konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-138">Configure a conditional decision in a workflow</span></span>](configure-conditional-decision-workflow.md)
+ [<span data-ttu-id="27ed6-139">Töövoos paralleeltegevuse konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-139">Configure a parallel activity in a workflow</span></span>](configure-parallel-activity-workflow.md)
+ [<span data-ttu-id="27ed6-140">Töövoos paralleelharu konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-140">Configure a parallel branch in a workflow</span></span>](configure-parallel-branch-workflow.md)
+ [<span data-ttu-id="27ed6-141">Rea kauba töövoo konfigureerimine</span><span class="sxs-lookup"><span data-stu-id="27ed6-141">Configure a line-item workflow</span></span>](configure-line-item-workflow.md)

...
### <a name="address-book"></a>Aadressiraamat
...
### <a name="budget"></a>Eelarve

| BPM-rida                    | Riik/regioon |
|-----------------------------|----------------|
| Eelarveplaani paigutuse muutmine | Üldine         |

### <a name="cash-management"></a>Kassahaldus
...
| \*Hiina kannete järjepidevuse kontrollimine                                                                                               | Hiina                             |
...
| \*Hiina kannete seadistamine                                                                                                        | Hiina                             |
...
| BPM-rida                                                     | Riik/regioon |
|--------------------------------------------------------------|----------------|
| \*Jõudluse töölehele kirje lisamine ja teistele tänu saatmine | Üldine         |
| \*Eesmärgi loomine                                              | Üldine         |
| \*Jõudluse ülevaate loomine                                | Üldine         |
...
| \*Tootenumbri nomenklatuuri loomine eelmääratletud tootevariantide jaoks | Üldine         |
| \*Tootenumbri nomenklatuuri loomine konfigureeritud tootevariantide jaoks | Üldine         |
...
| \*Mobiilse seadme menüükäsu loomine registreerimismärgi konsolideerimiseks          | Üldine         |
...
| Veose automaatse vastavusseviimise seadistamine                                     | Globaalne         |
| \*Kiirelt komplekteeritava kauba ümberjaotamise seadistamine                                    | Globaalne         |

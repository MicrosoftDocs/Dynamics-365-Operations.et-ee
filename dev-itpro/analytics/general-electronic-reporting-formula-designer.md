...
Järgmised näited käsitlevad järgmist.
<ul><li>Mudeli loetelu <strong>ReportDirection</strong>, mis on lisatud aruandesse andmeallikana <strong>$Direction</strong></li>
<li>ER-i avaldis <strong>$IsArrivals</strong>, mis on mõeldud kasutama mudeli loetelu selle funktsiooni parameetrina. Avaldise väärtus on <strong>TRUE</strong></li></ul></td>
</tr>
</tbody>
</table>

...
| Looge üksikasjalikumad eesmärgid.                                                                    | Teil on rohkem kontrolli teie seatud eesmärkide sisu üle. Saab luua eesmärkide jaoks mõõtmiseid, siduda jõudluse töölehe kirjeid mõõtmistega ning manustada ja vaadata dokumente. Saate talletada eesmärke mallidena ja taaskasutada neid kiirseadistuse jaoks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Looge eesmärgigrupid ja kasutage neid uute eesmärkide lisamiseks.                                             | Saate lisada grupile eesmärgimalle ja kasutada gruppi, et luua töötaja, meeskonna, positsiooni, osakonna või ettevõtte jaoks üks või rohkem eesmärke.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Juurdepääsu viis uus Power BI sisu packs inimressursi                                     | Uue sisu packs lubade kasutada programmi vahendite ja organisatsioonide personalijuhtide analüüsimiseks järgmised: tööjõu meetrika • demograafilised jaotused vanuse, soo ja perekonnaseisu • võrrelda hõõrdumine määra võrra väiksemaks ja töötajate lahkumise organisatsiooni • Vaata loetelu avatud positsioonide ning avatud ja suletud positsioonide hüvitist võrdlus ja eelised • võrrelda tunni andnud põhjust loend ja töötajate • Vaata osalesid saadaval kasu • vaadata töötajaid, kelle töötajate arv tööhõive järgi värbamine • analüüsida taotlejate hulgast taotlejad, kui nad tulevad, ja nad taotlemise organisatsioonilise koolituse • kursuse registreerimise olek • töötajate loendi asukoht • Couse osalemine positsioonide registreeritud kursused töötajate pädevust ja arengu • oskuste loetelu valduses töötajate • jaotus oskuste tüübid meeskonna liige |
...
<td>Pank akreditiivi Misc. Tasuta jaotamise vorm Saudi Araabia</td>
</tr>
<tr class="odd">
...
<td>See funktsioon on tootlikkuse täiustus. <strong>Näide</strong> müüte toodet, mille nimi on Polo t-särk. See toode on saadaval kahes värvitoonis: roheline ja sinine. Samuti on see saadaval kahes suuruses: väike ja keskmine. Värv ja suurus on Polo t-särgi aktiivsed tootedimensioonid. Kui sisestate Polo T-särgi müügirea, millel on värv Roheline ja suurus Väike, ei pea te sisestama andmeid väljadele <strong>Kaubakood</strong>, <strong>Värv</strong> ja <strong>Suurus</strong>. Saate luua rea, järgides üht järgmistest etappidest.
<ul>
...
### <a name="personalized-product-recommendations"></a>Toote isikupärastatud soovitused

| Mida saate teha                                                                                                                                                                                                                                                                        | Miks on see oluline                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Vaata toote isikupärastatud soovitused kell mitu puutepunkte müügikohtades (POS) määramiseks, mida klient võib olla huvitatud vastavalt oma ostuajalugu, oma lemmikute loendi üksuste ja üksuste, mida teised kliendid ostavad online ja Telliskivi-ja mördi kauplustes | Jaemüüjad suurte kataloogide, isikupärastatud soovitused aitavad kliendil toote tuvastamise ja anda poe seostab intelligentse clienteling. Pannakse toodetega, mis on suunatud kliendi huve ja osta harjumusi, toote soovitused aitavad jaemüüjad upsell ja tõstavad klientide hoidmine. Dynamics 365 toiminguteks - jaemüük, toote soovitused on powered by kognitiivse teenuste ja Microsoft Azure'i masinõppe. |
...
| Lisateave rakenduse Dynamics 365 for Operations veosetoes                                                                                                         | Toe partii protsesside kohta lisateabe saamiseks vt [saadetise](/dynamics365/operations/scm/inventory/consignment), [luua saadetise](/dynamics365/operations/scm/inventory/set-up-consignment), [luua saadetise tellimuse (ülesande juhend)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), ja [vahetavad omanikku partii lattu sisse tootmisnõudlust (ülesande juhend)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Määratlege otse müügitellimuse ridadel, kust tuleks nõudlus hankida ja kuidas seda tuleks hankida. <strong>Näide</strong> luua müügitellimuse reale ja määrake tarnetüüp on Otsetarne. Esmane hankija lisatakse müügitellimuse reale hankimispunktina.</td>
...
<tr class="even">
<td>Looge tellimuse lubaduse otse müügitellimuse ridadelt. <strong>Näide</strong> luua müügitellimuse rida, mis on hangitud kontsernisisese hankijana. Lahkuge realt. Tarnekuupäevad arvutatakse hankeettevõttes kättesaadavuse järgi.</td>

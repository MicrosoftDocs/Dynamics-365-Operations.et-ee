---
title: "Mis on uued või muudetud Dynamics AX 7.0 (veebruar 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Mis on uued või muudetud Dynamics AX 7.0 (veebruar 2016)
...
| Kasutage Business Connectorit äriloogika loomiseks ja integreerimisstsenaariumide toetamiseks.         | Business connector on saadaval kõne hallatavat koodi X ++ koodi. C kasutada business Connectoris ainult autor äriloogika\#, mitte integreerimise stsenaariume. | Business Connectorit ei toetata enam. Loomise nõude tingib asjaolu, et X++ on hallatavasse koodi kompileeritud. Seetõttu on interop lihtsam. Integreerimisstsenaariume täidetakse OData abil.       | Business Connectorit ei saa edasi liikudes kasutada.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Aruanne on lisatud, et erinevaid filtreid saate rakendada kasutaja vaatamisel aruande. Seejärel luuakse uus aruanne põhineb need filtrid.</td>
...
<td>"Jälgida tulemuslikkuse" Power BI sisu abil analüüsida finantsandmeid.</td>
<td>Pole saadaval</td>
...
<td>Dynamics AX-i praeguse versiooni spikrisüsteemi kuvab ülesande juhised, mis on salvestatud ja Microsoft Dynamicsi teenuse Lifecycle Services (LCS) BPM-i. Spikrisüsteemi kuvab ka Microsofti viki teemasid. Lisateabe saamiseks vaadake [Dynamics AX abi - alustanud](help-overview.md) ja [uus ülesanne teatmikke (veebruar 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Funktsioon on rakendatud kui elektroonilise aruandluse konfiguratsiooni. Funktsioon on saadaval Saksamaal ja Austrias.</td>
...
<td>Rühma kontod aruande saldod rakendataks julgeolekunõuete aruanne (LedgerAccountSum\_FR).</td>
...
<td>Listi Intrastat kaubakood on ühendatud toote hierarhia tüüpi kauba kood.</td>
...
<td>Intrastati kauba kood on tekstivälja täiendavate osakute tuvastamiseks ja ** toodetest kaardil on väli kogus kilogrammides lisaühikud tuvastamiseks.</td>
...
<tr class="odd">
<td>"Monitor jaemüügi kanali performance" Power BI sisu abil jaemüügi kanali andmeid analüüsida.</td>
<td>Pole saadaval</td>
...
<li>Kohapeal on "valmis" alternatiiv tarne pakette nagu kombineeritud saidi/lao/variant/transpordi mode, kiireim tarne (võimalikult kiiresti saadaval kuupäev) kriteerium, mida kasutaja saab valida vastavalt.</li>
